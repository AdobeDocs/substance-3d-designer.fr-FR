...
Ce fichier fournit des conseils aux agents d’IA et aux assistants de code (GitHub Copilot, Claude, etc.) lorsque vous travaillez avec du code dans ce référentiel.
