...
Pour afficher ou masquer un élément d&#39;interface spécifique, cliquez sur son nom dans le menu *Windows*. Les éléments affichés sont marqués d&#39;une coche ![](customizing-your-workspace.resources/customizing-your-workspace-01.png).
...
![Redimensionnement des quais](customizing-your-workspace.resources/customizing-your-workspace-03.gif "Redimensionnement des quais")
...
![Déplacement des quais](customizing-your-workspace.resources/customizing-your-workspace-04.gif "Déplacement des quais")
...
* Déplacer le dock à l&#39;aide de sa *barre de titre* et le placer *hors de la fenêtre principale* ou sur une zone de la fenêtre principale qui n&#39;est *pas un dock*. Vous pouvez réancrer ce dock en le déplaçant sur un autre dock *dans la fenêtre principale* ou en cliquant sur le bouton <b>![](customizing-your-workspace.resources/customizing-your-workspace-06.png) Réancrer</b> ;
* Cliquez sur le bouton <b>![](customizing-your-workspace.resources/customizing-your-workspace-07.png) Annuler l&#39;ancrage</b>. Un dock non ancré avec cette méthode peut *être réancré* uniquement en cliquant sur le bouton <b>![](customizing-your-workspace.resources/customizing-your-workspace-06.png) Réancrer</b>.

![Désancrage](customizing-your-workspace.resources/customizing-your-workspace-08.gif "Désancrage")
...
* Cliquer sur leur bouton <b>![](customizing-your-workspace.resources/customizing-your-workspace-09.png) Agrandir</b>
...
* Placement du curseur *sur le dock* et appui sur la touche <b>Maj+Espace</b>
* Cliquer sur leur bouton <b>![](customizing-your-workspace.resources/customizing-your-workspace-10.png) Réduire</b>
...
![Agrandissement des quais](customizing-your-workspace.resources/customizing-your-workspace-11.gif "Agrandissement des quais")
...
Pour épingle un dock, cliquez sur son bouton ![](customizing-your-workspace.resources/customizing-your-workspace-12.png) <b>Épingle</b>. Vous pouvez ensuite *retirer* l&#39;épingle à l&#39;aide du bouton ![](customizing-your-workspace.resources/customizing-your-workspace-13.png) <b>Retirer</b> pour qu&#39;il soit à nouveau *disponible* pour héberger tout nouveau contenu.
...
![Épingler les docks](customizing-your-workspace.resources/customizing-your-workspace-14.gif "Épingler les docks")

## Fermeture des docks

Tout dock peut être fermé en cliquant sur son bouton ![](customizing-your-workspace.resources/customizing-your-workspace-15.png) <b>Fermer</b>.
...
![Réinitialiser la mise en page](customizing-your-workspace.resources/customizing-your-workspace-16.gif "Réinitialiser la mise en page")
