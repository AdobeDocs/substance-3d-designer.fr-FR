...
Ce menu vous permet de gérer les principaux éléments de l’interface utilisateur de Designer. Chaque option est décrite dans la section <b>Windows</b> de [cette page](https://helpx.adobe.com/fr/substance-3d/unlisted/documentation/sddoc/the-main-menu-143720673.html) à propos de la barre d&#39;outils principale. Ici, nous allons fournir des concepts supplémentaires liés à ce menu.

### Afficher/Masquer une vue

Pour afficher ou masquer un élément d&#39;interface spécifique, cliquez sur son nom dans le menu *Windows*. Les éléments affichés sont marqués d&#39;une coche ![](../../assets/image2015-12-17-10-43-24.png).
...
Les options <b>Nouvel Explorateur</b>, <b>Nouvelle vue 3D</b> et <b>Nouvelle vue Bibliothèque</b> créent des vues, qui seront placées en fonction de l&#39;état actuel de l&#39;interface utilisateur :
...
![Redimensionnement des quais](../../assets/interface-customisation-resize.gif "Redimensionnement des quais")
...
![Déplacement des quais](../../assets/interface-customisation-move.gif "Déplacement des quais")
...
* Déplacer le dock à l&#39;aide de sa *barre de titre* et le placer *hors de la fenêtre principale* ou sur une zone de la fenêtre principale qui n&#39;est *pas un dock*. Vous pouvez réancrer ce dock en le déplaçant sur un autre dock *dans la fenêtre principale* ou en cliquant sur le bouton <b>![](../../assets/dock-icons-redock.png) Réancrer</b> ;
* Cliquez sur le bouton <b>![](../../assets/dock-icons-undock.png) Annuler l&#39;ancrage</b>. Un dock non ancré avec cette méthode peut *être réancré* uniquement en cliquant sur le bouton <b>![](../../assets/dock-icons-redock.png) Réancrer</b>.

![Désancrage](../../assets/interface-customisation-undock.gif "Désancrage")
...
* Cliquer sur leur bouton <b>![](../../assets/dock-icons-maximise.png) Agrandir</b>
...
* Placement du curseur *sur le dock* et appui sur la touche <b>Maj+Espace</b>
* Cliquer sur leur bouton <b>![](../../assets/dock-icons-minimise.png) Réduire</b>
...
> 
> * Les docks qui apparaissent/se mettent à jour automatiquement le font en arrière-plan (par exemple, Propriétés, Vue 2D)
...
![Agrandissement des quais](../../assets/interface-customisation-maximise.gif "Agrandissement des quais")
...
Pour épingler un dock, cliquez sur son bouton ![](../../assets/dock-icons-pin.png) <b>Épingler</b>. Vous pouvez ensuite *retirer* l&#39;épingle à l&#39;aide du bouton ![](../../assets/dock-icons-pinned.png) <b>Retirer</b> pour qu&#39;il soit à nouveau *disponible* pour héberger tout nouveau contenu.
...
* Utilisation simultanée de plusieurs graphiques

![Épingler les docks](../../assets/interface-customisation-pin.gif "Épingler les docks")

## Fermeture des docks

Tout dock peut être fermé en cliquant sur son bouton ![](../../assets/dock-icons-close.png) <b>Fermer</b>.
...
![Réinitialiser la mise en page](../../assets/interface-customisation-reset.gif "Réinitialiser la mise en page")
