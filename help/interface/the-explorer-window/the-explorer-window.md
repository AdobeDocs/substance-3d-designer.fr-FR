...
![](the-explorer-window.resources/graph-cleaner.jpg) <b>Supprimer les nœuds inutilisés</b> dans le ou les graphes sélectionnés. L’outil suit les règles suivantes :
