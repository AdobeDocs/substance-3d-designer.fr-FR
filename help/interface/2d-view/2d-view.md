...
* <b>Ajuster à la fenêtre d&#39;affichage :</b> F / bouton « Ajuster à la vue » ![](../../assets/2d-view-icon-fit-to-view.png)
...
![Sorties du graphique de changement d&#39;affichage 2D](../../assets/2d-view-switch-graph-outputs.gif "Sorties du graphique de changement d&#39;affichage 2D"){width="360px"}



Si l&#39;image actuellement affichée est une *sortie graphique*, vous pouvez *rapidement passer à n&#39;importe quelle* autre sortie graphique à l&#39;aide du bouton ![](../../assets/2d-view-icon-view-outputs.png) <b>Sélectionner la sortie</b>.
...
+++Incrustation UV
![Incrustation UV de vue 2D](../../assets/2d-view-uv.png "Incrustation UV de vue 2D"){width="357px"}
...
![Informations sur l&#39;image vue en 2D](../../assets/2d-view-information.png "Informations sur l&#39;image vue en 2D"){width="360px"}



Vous pouvez afficher les *valeurs de pixel exactes* *et les* dans une image à l&#39;aide du panneau <b>Informations</b>, qui est activé à l&#39;aide du bouton ![](../../assets/2d-view-icon-information.png) <b>Informations sur l&#39;image</b>. Cela s’avère très utile lors de l’inspection d’images HDR, par exemple, ou pour s’assurer que le passage d’un pixel à l’autre suit la progression prévue.
...
+++Histogramme
![Histogramme de l&#39;affichage 2D](../../assets/2d-view-histogram.png "Histogramme de l&#39;affichage 2D"){width="360px"}
...
![Couches de couleur de la vue 2D](../../assets/2d-view-color-channel.png "Couches de couleur de la vue 2D"){width="360px"}
...
![Bouton de transparence de l&#39;affichage 2D](../../assets/2d-view-transparency.png "Bouton de transparence de l&#39;affichage 2D"){width="360px"}
...
<b>![](../../assets/2d-view-icon-transparency-straight.png) Direct :</b> les informations de transparence sont uniquement stockées dans la couche alpha et n&#39;ont aucune incidence sur les autres aspects de l&#39;image

<b>![](../../assets/3d-view-icon-transparency-premultiplied.png) prémultiplié :</b> les informations de transparence sont stockées dans la couche alpha. Elles ont également un impact sur les couches RGB, car elles sont effectivement multipliées par rapport à la couche alpha
...
![Espace colorimétrique de la vue 2D](../../assets/2d-view-viewport-color-space.png "Espace colorimétrique de la vue 2D"){width="360px"}
