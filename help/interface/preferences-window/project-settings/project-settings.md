---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-designer/interface/preferences-window/project-settings.html"
breadcrumb-title: ''
...
Les alias sont utilisés pour *raccourcir* les chemins système et permettre aux équipes de *partager* les ressources plus efficacement. Les alias sont utilisés *dans tout le logiciel* ainsi que dans *les fichiers SBS*.
...
|                               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Nom de ressource par défaut</b> | Ce paramètre vous permet de définir un **modèle de dénomination** par défaut qui sera utilisé pour les fichiers image de sortie. Les alias disponibles dans la [fenêtre de baking](../../../bakers/bakers.md) peuvent également être utilisés ici (par exemple, *$(maillage)*, *$(bakername)*, *$(udim)*, *$(custom)*)<br><br>*Par défaut : $(maillage)\_$(bakername)* |
| <b>Paramètre prédéfini par défaut</b> | Lors de l&#39;ouverture de la [fenêtre de baking](../../../bakers/bakers.md), vous pouvez la **configurer** avec des bakers et des paramètres spécifiques en utilisant cette option pour pointer vers un fichier *JSON* prédéfini. Ce fichier peut être exporté à partir de la fenêtre de baking une fois qu&#39;il a été configuré selon vos besoins <br><br>*Par défaut : aucun* |
| <b>mode de filtrage de nom</b> | L&#39;objet des scènes dont le nom doit être utilisé pour correspondre aux objets des scènes à faible et à fort poly :<ul data-preserve-html="true"> <li data-preserve-html="true">Nom de la géométrie : utilisez le nom de l&#39;objet géométrique du maillage</li> <li data-preserve-html="true">Nom du parent (hérité) : utilisez le nom du parent de l’objet géométrique du maillage (identique à celui utilisé dans Designer versions 14.1 et antérieures)</li> </ul>*Par défaut : nom de la géométrie* |
| <b>Macros de nom de ressource</b> | Au lieu de l&#39;alias *$(bakername)*, vous pouvez utiliser vos propres chaînes de caractères pour [chaque baker](https://experienceleague.adobe.com/fr/docs/substance-3d/bakers/bakers-settings/bakers-settings).  Lorsque l&#39;alias ***$(personnalisé)*** est utilisé dans le nom d&#39;image de sortie pour un baker, il est remplacé par la chaîne de caractères correspondant à ce baker dans la liste. Si une cellule de la liste correspondant à un baker reste vide, l&#39;alias *$(personnalisé)* *ne sera pas* remplacé pour ce baker. Exemple : la valeur de &#39;c-maillage affectée au baker &#39;Map curvature depuis le maillage&#39; renommera automatiquement *t\_mymesh\_&#x200B;**$(personnalisé)*** en *t\_mymesh\_&#x200B;**c-maillage*** pour la sortie du baker Courbure à partir du Maillage *uniquement *<br><br>*Par défaut : aucun* |
| <b>Filtre Nom des sous-maillages</b> | Lorsque vous utilisez l&#39;option **Correspondance par nom** dans les [bakers](../../../bakers/bakers.md), les parties des versions basse et haute définition d&#39;un maillage sont *correspondantes* si le nom de ces parties avant les **suffixes** définis est *identique*. Ce paramètre vous permet de définir vos propres suffixes en fonction de votre workflow spécifique. La correspondance de parties de maillages peut faire que les rayons ignorent la géométrie indésirable dans les opérations de baking. Exemple : l&#39;objet *body-torso&#x200B;**\_low*** dans le maillage *body.fbx* correspondrait à l&#39;objet *body-torso&#x200B;**\_high &#x200B;*** dans *body\_high.fbx,* *si ces objets existent* dans ces maillages *.**Par défaut : \_low (Maillage low poly) / \_high (Maillage high poly)*De même,**&#x200B;les faces arrière&#x200B;**peuvent être *sélectionnées ignoré* pour les parties d&#39;un maillage dont le nom inclut le &#x200B;** suffixe&#x200B;**défini, pour [les bakers spécifiques](https://experienceleague.adobe.com/fr/docs/substance-3d/bakers/bakers-settings/bakers-settings) qui incluent l&#39;option &#x200B;** Ignorer le dos**<br><br>* Par défaut : \_ignorebf *<br><br>* Remarque :* Les suffixes Ignorer le dos et Faible/Maillage high poly peuvent être *combinés dans n&#39;importe quel ordre* (par exemple *body-torso\_low\_ignorebf*) |
...
|                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Modèles de Substance</b> | Lors de la création d&#39;un nouveau graphe, vous êtes invité à commencer à travailler à partir d&#39;un **modèle** qui peut avoir un certain nombre de paramètres et de contenus *préconfigurés*, tels que des sorties (par exemple *PBR (Métallique/Rugosité)*). Ce paramètre vous permet de pointer Designer vers des répertoires où vous pouvez stocker vos propres fichiers SBS à utiliser comme modèles. Vos modèles personnalisés seront ensuite *ajoutés à la liste* lors de la création d&#39;un nouveau graphe <br><br>*Par défaut : aucun *<br><br>*Remarque :* Nous vous recommandons d&#39;utiliser les modèles actuels comme référence pour la configuration et le formatage de vos fichiers SBS de modèles.  Les modèles se trouvent dans le dossier **ressources > modèles** du répertoire d&#39;installation de Substance 3D Designer. |
...
Si un document [Photoshop](https://www.adobe.com/fr/products/photoshop.html) (fichier\*.PSD) inclus dans la bibliothèque comporte <b>plusieurs calques</b>, une option vous permet d&#39;afficher le contenu de* chaque calque sous la forme d&#39;une entrée d&#39;image distincte* dans la bibliothèque.
