...
Le contenu de tous les dossiers répertoriés dans la liste <b>Chemins ajoutés</b> sera inclus dans la bibliothèque. Toute modification apportée au contenu est répercutée dans la bibliothèque, après une période d&#39;actualisation qui peut être définie dans l&#39;[onglet[Bibliothèque](../../../interface/preferences-window/preferences-window.md)](../../../interface/preferences-window/preferences-window.md) de la fenêtre [Préférences](../../../interface/preferences-window/preferences-window.md).
