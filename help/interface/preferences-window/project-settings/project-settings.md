...
| <b>Nuanceur par défaut</b> | Ce paramètre vous permet de sélectionner le nuanceur qui doit être utilisé par défaut lors du démarrage d&#39;une *nouvelle* [vue 3D &#x200B;](../../../interface/3d-view/3d-view.md)<br><br>*Par défaut : open_pbr.glslfx* |
| <b>Mappage d&#39;environnement par défaut</b> | Ce paramètre vous permet de sélectionner la texture qui doit être appliquée par défaut à l&#39;environnement lors du démarrage d&#39;une *nouvelle* [vue 3D &#x200B;](../../../interface/3d-view/3d-view.md)<br><br>*Par défaut : panorama\_map.hdr* |
| <b>Fichier d&#39;état par défaut</b> | Le [fichier d&#39;état de scène **de la vue 3D](../../../interface/3d-view/3d-view.md)** comprend un certain nombre de paramètres pour la vue 3D, tels que la position de la caméra, l&#39;exposition de l&#39;environnement et le filet. Il est utilisé pour stocker l’état de la vue 3D afin que vous puissiez charger rapidement une scène adaptée à vos besoins. Les fichiers d&#39;état de scène utilisent l&#39;extension **\*.sbsscn**.Ce paramètre vous permet de sélectionner le fichier d’état de scène de vue 3D qui doit être utilisé lors du démarrage d’une nouvelle vue 3D.  **Alerte :** certaines mises à jour logicielles peuvent modifier la façon dont les états de scène sont enregistrés/chargés. Si la scène n&#39;est *pas correctement restaurée*, il est recommandé de définir manuellement l&#39;état souhaité de la scène et de *réexporter* le fichier d&#39;état de scène que vous utilisez par défaut. <br><br>*Par défaut : vide (dans ce cas, un état de scène prédéfini est utilisé)* |
...
| <b>Scènes 3D</b> | Par défaut, Designer utilise l&#39;**espace tangent MikkT** dans la vue 3D. MikkT est largement utilisé et constitue la valeur par défaut dans des programmes tels que Unity, Unreal Engine 4, Blender et xNormal. Vous pouvez utiliser **votre propre espace tangent** pour la vue 3D, que vous fournissez à Designer sous la forme d&#39;un fichier *DLL* d&#39;entrée dans ce paramètre. Le libellé est détecté automatiquement à partir du fichier DLL et vous pouvez modifier la description du plug-in <br><br>*Par défaut : mikktspace.dll* Toujours recalculer les images tangentes <br><br>*Par défaut : décoché* Angle de lissage normal et tangent <br><br>*Par défaut : 180,0°* |
...
> Voir la section [Gestion du contenu et des filtres personnalisés](https://helpx.adobe.com/fr/substance-3d/unlisted/documentation/sddoc/creating-library-filters-for-projects-170459772.html) de la documentation pour plus d&#39;informations.
