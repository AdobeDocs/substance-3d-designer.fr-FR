...
* <b>Se concentrer sur un maillage sélectionné :</b> F (se concentre sur la scène entière s&#39;il n&#39;y a pas de sélection)
...
Vous pouvez faire pivoter cet environnement autour de votre objet 3D ou charger des environnements d’éclairage HDR prédéfinis ou personnalisés. Veuillez noter que vos images HDR doivent avoir une projection équirectangulaire et une précision de 32 bits en virgule flottante.

⇧+RMB+Faire glisser <b>fait pivoter l&#39;environnement</b> dans la vue 3D.

Pour définir une rotation précise, utilisez <b>Environnement > Modifier</b> dans la barre d&#39;outils supérieure de vue 3D et modifiez le curseur <b>Angle de rotation</b> dans la fenêtre des propriétés.

Pour utiliser un environnement d&#39;éclairage HDR prédéfini, cliquez sur la section <b> Environnements HDRI</b> de la catégorie <b>vue 3D</b> dans la [Bibliothèque](../../interface/the-library/the-library.md), puis faites glisser l&#39;une des icônes vers la vue 3D.
...
Vous pouvez voir des matériaux entiers comme un matériau complet dans la vue 3D. Il s&#39;agit de la méthode de travail la plus courante. Elle fera correspondre les [attributs d&#39;utilisation sur les nœuds de sortie](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md) aux emplacements de texture pertinents du matériau de vue 3D. Cela signifie que vos sorties doivent être définies correctement (l’utilisation de Modèles permet de s’assurer que c’est le cas) et que vous avez sélectionné matériau/viewport pris en charge par shader

Pour afficher toutes les sorties d&#39;un graphe, cliquez sur *RMB* dans une zone vide de la [Vue du graphe](../../interface/the-graph-view/the-graph-view.md), puis sélectionnez l&#39;option **Afficher les sorties en vue 3D** dans le menu contextuel.

Vous pouvez également afficher les sorties d&#39;un graphe sans avoir à l&#39;ouvrir, en cliquant sur le RMB d&#39;une ressource de graphe dans le dock [Explorateur](../the-explorer-window/the-explorer-window.md) et en choisissant l&#39;option **Afficher les sorties en vue 3D** dans le menu contextuel.
...
Lorsque *charge un graphe*, ses sorties sont automatiquement appliquées dans la vue 3D par défaut. Vous pouvez désactiver ce comportement dans les [Préférences](../../interface/preferences-window/preferences-window.md). Accédez à **Édition > Préférences > Graphe > Commun** et décochez l&#39;option **Afficher les sorties en vue 3D lors de l&#39;ouverture d&#39;un graphe**.

>[!NOTE]
>
> **Plusieurs Emplacements De Matériau**
> 
...
Vous pouvez afficher une seule sortie dans n&#39;importe quel canal matériau disponible dans la [vue 3D](https://substance3d.adobe.com/). Cette option est moins fréquemment utilisée, mais elle est idéale pour prévisualiser des tests rapides ou des nœuds individuels sans sortie.

Vous pouvez afficher n&#39;importe quel nœud, pas seulement les nœuds de sortie, en cliquant dessus avec le bouton droit dans la [Vue du graphe](../../interface/the-graph-view/the-graph-view.md) et en choisissant <b>Afficher dans vue 3D</b>. Une liste des canaux disponibles auxquels attribuer le nœud s’affiche. Cliquez sur n’importe lequel pour confirmer.

Vous pouvez également utiliser *RMB* pour faire glisser n&#39;importe quel nœud de la Vue du graphe vers la vue 3D. Une liste des canaux disponibles auxquels attribuer le nœud s’affiche. Cliquez sur n’importe lequel pour confirmer.
...
* Utilisez la *map normal* par maillage qui fournira les normales correctes
* *Recalculez les normales de maillage* lors de l&#39;exportation à l&#39;aide de la map de maillage normal, ce qui signifie que ces normales sont bakées dans le maillage exporté et que la map normal n&#39;est plus nécessaire

Pour exporter le maillage vue 3D, accédez à <b>Scène > Exporter le maillage tesellé...</b>, définissez votre choix en matière de recalcul des normales, puis sélectionnez un emplacement, un nom et un format de fichier pour le maillage exporté.
...
> Quelques réserves
> 
> Si le maillage d&#39;origine comporte plusieurs matériaux et/ou Ensembles d&#39;UV, ils seront *fusionnés en un*.
> 
> La durée du processus d&#39;exportation et la taille du fichier obtenu dépendent du nombre de triangles par maillage et du *facteur de tessellation*. Des valeurs de facteur de tessellation élevées peuvent entraîner une instabilité en fonction du pool de mémoire intégré du GPU.
> 
> Cela dit, le nombre de vertex du maillage facettisé doit être dans la *même plage* que le nombre de pixels de la carte *height*.
> 
> Avoir un maillage plus dense que la map height peut rendre le maillage légèrement plus lisse lors de l&#39;utilisation de la tessellation <b>Phong</b>. Toutefois, vous devez viser à exporter le maillage de manière fiable avec les détails de map height requis en premier, puis à affiner le maillage exporté dans d&#39;autres logiciels si nécessaire.
...
<b>Modifier :</b>charge les options de scène dans le panneau [Propriétés](../../interface/properties/properties.md). Active/désactive la visibilité du maillage 3D.

<b>Primitives standard :</b> présente l’un des maillages 3D simples ci-dessous dans la vue 3D.
...
<b>Primitives étendues :</b> présente l’un des maillages 3D ci-dessous dans la vue 3D.
...
<b>UV d&#39;affichage en vue 2D :</b> active l&#39;affichage des UV pour le maillage actuellement sélectionné en tant qu&#39;incrustation dans la [vue 2D](../2d-view/2d-view.md).

<b>Créer une ressource 3D à partir de la scène active...:</b> Crée une nouvelle [ressource Scène 3D](../../resources/3d-scene-resource/3d-scene-resource.md) dans un package à partir de la scène active.

<b>Charger le fichier d&#39;état... : </b>Charge un fichier d&#39;état de scène de données [enregistré en externe](../../working-with-3d-scenes/working-with-3d-scenes.md) (\*.sbsscn). Ne remplace pas le Maillage 3D, charge uniquement les paramètres du rendu 3D, de la caméra et des éclairages.

<b>Charger le fichier d&#39;état avec maillage...:</b> Charge un [fichier d&#39;état de scène](../../working-with-3d-scenes/working-with-3d-scenes.md) enregistré en externe (\*.sbsscn). Charge les paramètres de rendu 3D, de caméra, d’éclairage, ainsi que sa Scène 3D de référence. .
...
<b>Enregistrer l&#39;état actuel comme valeur par défaut :</b>Définissez l&#39;état actuel de la vue 3D en tant que [fichier d&#39;état de scène](../../working-with-3d-scenes/working-with-3d-scenes.md) à utiliser par défaut lors de la création de nouvelles vues 3D. Ce fichier est chargé chaque fois que la vue 3D est réinitialisée ou initialisée. Il peut être défini dans les [paramètres du projet](../../interface/preferences-window/project-settings/project-settings.md).

<b>scène d&#39;exportation :</b> *(Pixellisation/Rendu de Pathtracer GPU uniquement)* Exporte la scène active en tant que [scène aplatie](../../working-with-3d-scenes/exporting-scenes/exporting-scenes.md), où seule la scène finale est écrite et où toutes les références à la scène d&#39;origine sont perdues. Le contenu de la scène exportée dépend des fonctions prises en charge par le format d’exportation sélectionné.\
Formats disponibles : STL, FBX, GLB, GLTF, PLY, USDC, USD, USDA, USDZ, OBJ.

<b>Exporter la scène avec les calques :</b> *(Rendu pixellisé/Pathtracer GPU uniquement)*Exporte la scène active en tant que [scène multicalque](../../working-with-3d-scenes/exporting-scenes/exporting-scenes.md), où toutes les modifications apportées à la scène d&#39;origine sont enregistrées dans des fichiers séparés dans un workflow non destructif. Cette option est uniquement disponible pour les formats de fichier USD.\
Les formats disponibles sont : USDC, USD, USDA.

<b>Exporter la géométrie répartie :</b> *(moteur de rendu OpenGL uniquement)* Exporte la scène active avec la tessellation comme géométrie brute, voir la section Exporter la scène.

<b>Réinitialiser la scène :</b>réinitialise la vue 3D par défaut.

Certaines mises à jour logicielles peuvent modifier la façon dont les fichiers d’état de Scène de données sont enregistrés/chargés.

Si la scène de données n&#39;est *pas correctement restaurée* à partir du fichier, il est recommandé de définir manuellement l&#39;état souhaité de la scène de données et de *réexporter* le fichier d&#39;état de la Scène de données.

+++

+++Matériaux
Le menu <b>Matériaux</b> change en fonction du Maillage 3D chargé et du moteur de rendu utilisé.

Le menu Matériaux comporte une liste de tous les matériaux affectés à un maillage dans la scène. Chaque matériau répertorié dans le menu « Matériaux » comporte un sous-menu d’actions de matériau :

<b>Modifier</b> : modifiez les paramètres du matériau actif dans la fenêtre Propriétés.
...
<b>Réinitialiser le matériau :</b> réinitialise tous les paramètres shader à leurs valeurs par défaut. Si des textures sont connectées à l&#39;un des échantillonneurs du shader, elles sont déconnectées.

<b>Réinitialiser le matériau à l&#39;état de scène : </b>*(Rendu pixellisé/Pathtracer GPU uniquement)* Réinitialise toutes les propriétés des [matériaux remplacés](../../working-with-3d-scenes/overriding-scene-mat/overriding-scene-materials.md) à leurs valeurs d&#39;origine à partir de la scène, y compris les textures d&#39;origine, le cas échéant.

<b>Ajouter :</b>Ajoute un nouveau matériau à la liste. Il n&#39;est pas utilisé par défaut et peut être [connecté à un matériau de scènes](../../working-with-3d-scenes/overriding-scene-mat/overriding-scene-materials.md) à l&#39;aide de l&#39;[explorateur de Scènes](../../interface/3d-view/scene-browser/scene-browser.md).

+++

+++Lumières
Le menu <b>Éclairages</b> ne traite que des éclairages ambiants et ponctuels plus anciens. Ces éclairages ne sont pas conformes à la norme PBR et ne donnent pas les mêmes résultats de haute qualité que le rendu d’image HDR.
...
+++Caméra
Le menu <b>Caméra</b> vous permet de modifier les paramètres de caméra, d&#39;accéder à des angles prédéfinis et de charger des angles de Caméra stockés dans un fichier Maillage 3D personnalisé.

<b>Modifier les propriétés :</b> ouvre les paramètres de la caméra par défaut dans le dock des propriétés.

<b>Focus :</b>(F) Focalise la caméra par défaut sur le maillage actuellement sélectionné. Par exemple, cadre le maillage et aligne le pivot de la caméra sur celui-ci. S’il n’y a pas de sélection active, le cadre de sélection global de la scène est utilisé.
...
<b>Enregistrer le rendu...:</b> (Alt+S) Enregistre l&#39;image actuellement rendue sur le disque, à la résolution spécifiée dans les propriétés du rendu ou dans les propriétés de la caméra par défaut si une résolution de remplacement a été configurée.
...
<b>Modifier les propriétés :</b> donne accès aux paramètres d&#39;environnement HDR, utilisés pour l&#39;éclairage dans PBR. Plus précisément, vous pouvez basculer la visibilité, modifier l’exposition avec un aperçu et définir la rotation à l’aide d’un curseur précis.
...
La barre d&#39;outils <b>Affichage</b>, qui se trouve par défaut au *bas* du panneau <b>vue 3D</b>, vous permet de contrôler l&#39;affichage de l&#39;image rendue dans le viewport.
