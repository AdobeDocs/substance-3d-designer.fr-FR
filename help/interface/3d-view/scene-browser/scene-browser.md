...
Elle offre des commandes pour sélectionner des objets, activer/désactiver leur visibilité ainsi que sélectionner le matériau qui doit [remplacer un matériau de scène](../../../working-with-3d-scenes/overriding-scene-mat/overriding-scene-materials.md).
