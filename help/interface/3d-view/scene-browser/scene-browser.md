...
Il s&#39;affiche en cliquant sur son bouton bascule dédié ![](scene-browser.resources/scene-browser-01.png) dans la [barre d&#39;outils de la scène de vue 3D](../../../interface/3d-view/3d-view.md).

![Explorateur de Scènes - Scène 3D chargée](scene-browser.resources/scene-browser-02.png "Explorateur de Scènes - Scène 3D chargée"){zoomable="yes"}
...
![Scene browser - Objets ajoutés par Designer et répertoriés en gras](scene-browser.resources/scene-browser-04.png "Scene browser - Objets ajoutés par Designer et répertoriés en gras"){zoomable="yes"}
...
La visibilité d&#39;un objet peut être basculée en cliquant sur son bouton d&#39;œil ![](scene-browser.resources/scene-browser-05.png) ou à partir de son menu contextuel. Le menu propose quelques actions supplémentaires pour gérer la visibilité des objets de la scène :
...
![Explorateur de scènes - Activation/désactivation de la visibilité des objets](scene-browser.resources/scene-browser-06.gif "Explorateur de scènes - Activation/désactivation de la visibilité des objets"){zoomable="yes"}
...
![Explorateur de scènes - Activation/désactivation de la visibilité de l’environnement](scene-browser.resources/scene-browser-07.gif "Explorateur de scènes - Activation/désactivation de la visibilité de l’environnement"){zoomable="yes"}

### Lumières

Il en va de même pour tous les éclairages de la scène : vous pouvez basculer individuellement.

![Explorateur de scènes - Activation/désactivation de la visibilité de la lumière](scene-browser.resources/scene-browser-08.gif "Explorateur de scènes - Activation/désactivation de la visibilité de la lumière"){zoomable="yes"}
...
![Explorateur de scènes - Matériau connecté](scene-browser.resources/scene-browser-09.png "Explorateur de scènes - Matériau connecté"){zoomable="yes"}
