...
breadcrumb-title: ''
description: Utilisez le rendu Iray dans la vue 3D de Substance 3D Designer pour obtenir un aperçu physique du matériau et un éclairage réaliste.
...
Cette page présente le moteur de rendu Iray disponible dans le panneau d&#39;affichage 3D de [Substance 3D Designer](https://www.adobe.com/fr/products/substance3d-designer.html), qui offre un traçage de chemin interactif pour un rendu photoréaliste avec accélération CPU et/ou GPU (GPU Nvidia uniquement).

>[!WARNING]
> 
> Le moteur de rendu Iray et toutes les fonctionnalités associées ont été supprimés de Designer dans la version 16.0.0.
> 
...
Comme la vue 3D utilise le *moteur de rendu progressif* d&#39;Iray, une image est produite dès qu&#39;au moins un échantillon a été effectué sur chaque pixel. L&#39;image est *automatiquement mise à jour* à mesure que les itérations d&#39;échantillonnage sont effectuées, ce qui permet d&#39;obtenir une image brute initiale *plus nette sur chaque itération*.

Le moteur de rendu est disponible dans le panneau [Vue 3D](../../../interface/3d-view/3d-view.md) : ouvrez le menu <b>Moteur de rendu</b> et sélectionnez l’option <b>Iray</b> pour basculer le moteur de rendu utilisé dans ce panneau de vue 3D sur Iray.\
Le passage au moteur de rendu d&#39;Iray *modifie les options disponibles* dans certains menus de vue 3D. Ces modifications sont expliquées dans la section <b>Vue 3D</b> ci-dessous.
...
>[!WARNING]
>
> Seule *une* instance de rendu d&#39;Iray peut être exécutée à tout moment.\
...
Sélectionnez l&#39;option <b>Modifier</b> dans le menu <b>Scène</b> pour rechercher les propriétés de scène spécifiques à l&#39;Iray dans le panneau <b>Propriétés</b>.

* <b>Est activé :</b> lorsqu&#39;il est défini sur *Faux*, l&#39;objet est masqué et *ne contribue plus* à la scène

Afficher le composant

* <b>Est visible</b> : lorsqu&#39;il est défini sur *Faux*, l&#39;objet est masqué, mais *contribue* à la scène, c&#39;est-à-dire qu&#39;il réfléchit la lumière, absorbe la lumière et projette des ombres

composant d&#39;affichage de maillage

* Sous-division
  * <b>Méthode</b> : méthode utilisée pour subdiviser procéduralement le maillage en une géométrie plus fine
    * *Aucun* : aucune subdivision n&#39;est appliquée
    * *Paramétrique* : subdivise le maillage en `4^x` triangles où `x` est la valeur spécifiée par ce paramètre
    * *Longueur* : divise le maillage jusqu&#39;à ce que tous ses bords aient une longueur (en espace objet) inférieure à la valeur spécifiée par le paramètre Longueur minimale
  * <b>Longueur minimale</b> : divise le maillage jusqu&#39;à ce que tous ses bords aient une longueur inférieure à cette valeur spécifiée dans l&#39;espace objet (s&#39;applique uniquement à la méthode *Length*)
...
En outre, si un [Graphe MDL](../../../mdl-graphs/creating-an-mdl-graph/creating-an-mdl-graph.md) est chargé dans Designer, il peut être appliqué à n&#39;importe quel matériau de la Scène. À ce stade, il est ajouté à la liste des Matériaux MDL disponibles.

Les autres options notables de ce menu sont les suivantes :

* Sélectionnez l&#39;option <b>Modifier</b> pour accéder aux *entrées exposées* du MDL dans le panneau <b>Propriétés</b> et ajustez le matériau selon vos besoins
* L&#39;option <b>Charger...</b> vous permet de *charger manuellement n&#39;importe quel fichier MDL* à ajouter à la liste cumulative et à appliquer dans la scène
* L&#39;option <b>Exporter le paramètre prédéfini...</b> ouvre la boîte de dialogue <b>Exporter le paramètre prédéfini de Matériau MDL</b>, qui vous permet d&#39;exporter un fichier MDL de paramètre prédéfini à l&#39;aide des paramètres actuellement appliqués dans vue 3D
...
>[!NOTE]
>
> Lors du chargement d&#39;un **Graphe MDL**, le moteur de rendu de vue 3D est *automatiquement basculé sur **Iray*** pour le charger et l&#39;appliquer.

<a name="camera"></a>

### Caméra

La principale différence entre OpenGL et Iray en ce qui concerne les paramètres de caméra réside dans la façon dont la *profondeur de champ* est gérée. En effet, l&#39;Iray étant un moteur de rendu physiquement précis, la profondeur de champ se produit « naturellement » en fonction de l&#39;*ouverture* de la caméra.

Les paramètres suivants sont disponibles dans les propriétés de caméra lorsque le moteur de rendu d’Iray est sélectionné :
...
* <b>Type de Dôme</b> : définit les objets qui entourent la scène, sur laquelle la texture d&#39;environnement est projetée
  * *Sphère infinie* : environnement sphérique infini
  * *Sol* : environnement sphérique infini, mais avec un plan de sol texturé
  * *Sphère* : dôme en forme de sphère de taille finie de rayon personnalisé
  * *Sphère avec sol* : dôme en forme de sphère de taille finie avec un rayon personnalisé où la partie inférieure de l&#39;environnement est projetée sur le plan séparant les parties supérieure et inférieure de la sphère
  * *Boîte avec sol* : dôme en forme de boîte de taille finie de largeur, d&#39;height et de longueur personnalisés où la partie inférieure de l&#39;environnement est projetée sur le plan divisant les parties supérieure et inférieure de la boîte
* <b>Angle de rotation</b> : contrôle l&#39;angle de rotation du dôme autour de l&#39;*axe Y*
* <b>Rayon</b> : le rayon de la sphère (s&#39;applique uniquement aux types de dômes *Sphère* et *Sphère avec sol*)
* <b>Largeur</b> : la largeur du cadre (s&#39;applique uniquement au type de dôme *Cadre avec sol*)
* <b>Height</b> : l&#39;height de la zone (s&#39;applique uniquement au type de dôme *Zone avec sol*)
* <b>Longueur</b> : longueur de la zone (s&#39;applique uniquement au type de dôme *Zone avec sol*)
* <b>Visualiser</b> : active une incrustation de fausse couleur de la géométrie de l&#39;environnement de taille finie. Cela peut être utilisé pour aligner la géométrie avec la projection de la map d&#39;environnement capturée (s&#39;applique uniquement aux types de dômes *Sphère*, *Sphère avec sol* et *Boîte avec sol*)
...
sol dôme\
Les paramètres suivants s&#39;appliquent aux types de dômes *Sol*, *Sphère avec sol* et *Box avec sol* :

* **Sol** : active le plan du sol
...
* **Intensité de l&#39;ombre** : opacité du convertit d&#39;ombre en sol
* **Échelle de Texture** : contrôle la taille de la projection de texture d&#39;environnement sur le sol (s&#39;applique également au type de dôme *Sphère*)
...
* <b>Échantillonneur caustique activé</b> : augmentez l’échantillonneur par défaut avec un échantillonneur caustique dédié. Les caustiques résultent du passage de lumière à travers un objet non opaque. Ils ne sont donc nécessaires que si un translucency de support de matériau [MDL](../../../mdl-graphs/creating-an-mdl-graph/creating-an-mdl-graph.md) est appliqué sur un objet de la scène
...
* Post denoiser\
  Le module de rendu d&#39;Iray utilise l&#39;algorithme [dénoiseur accéléré par IA NVIDIA Optix](https://developer.nvidia.com/optix-denoiser) pour le dénoisage itératif de haute qualité de l&#39;image pendant le rendu.
  ...
  * <b>Démarrer l&#39;itération</b> : si le dénoiseur est activé, cette option définit l&#39;itération à laquelle le processus de dénoisage commence. Cela peut empêcher les frais généraux de performance du dénoiseur d&#39;affecter l&#39;interactivité, par exemple, lors du déplacement de la caméra. De plus, les premières itérations ne sont souvent pas appropriées comme entrée pour le dénoiseur en raison d&#39;une convergence insuffisante, ce qui conduit à des résultats insatisfaisants.
...
Le moteur de rendu d’Iray offre une accélération matérielle sur les GPU NVIDIA exclusivement, ce qui offre les avantages suivants :
...
>[!NOTE]
>
> Si un GPU pris en charge est détecté et répertorié, nous vous recommandons vivement de *laisser le processeur désélectionné*, car l’utilisation du processeur pour l’Iray du rendu a un *impact significatif* sur les performances globales et la réactivité de l’application.
