...
Dans la barre d&#39;outils Vue du graphe, cliquez sur le bouton <b>Node Finder ![](../../../assets/graph-node-finder.png)</b> pour afficher la barre d&#39;outils Node Finder. Une fois affichée, la barre d’outils se ferme uniquement en cliquant sur ce bouton.
...
![Outil de recherche de nœuds : paramètres exposés](../../../assets/node-finder-compositing-exposed-parameter.png "Outil de recherche de nœuds : paramètres exposés"){zoomable="yes"}
