...
![Icône de nœud de point](dot-node.resources/dot-node-01.png "Icône de nœud de point")
...
![Insertion d&#39;un nœud de point](dot-node.resources/dot-node-02.gif "Insertion d&#39;un nœud de point"){width="512px"}
...
![Point : création à partir du connecteur](dot-node.resources/dot-node-03.gif "Point : création à partir du connecteur")
...
![Nœud point dans le menu Nœud](dot-node.resources/dot-node-04.png "Nœud point dans le menu Nœud")
...
![Fusion des liens](dot-node.resources/dot-node-05.gif "Fusion des liens"){width="512px"}
...
![Nœud point comme portail - icône](dot-node.resources/dot-node-06.png "Nœud point comme portail - icône")
...
![Nœud point comme portail](dot-node.resources/dot-node-07.gif "Nœud point comme portail")
