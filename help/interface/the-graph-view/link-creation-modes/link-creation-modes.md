...
![Mode de création de lien : standard](link-creation-modes.resources/link-creation-modes-01.gif "Mode de création de lien : standard"){zoomable="yes"}
...
![Mode de création de lien : matériau](link-creation-modes.resources/link-creation-modes-03.gif "Mode de création de lien : matériau"){zoomable="yes"}

*Cliquer pour agrandir*

![](link-creation-modes.resources/link-creation-modes-04.png) <b>Matériau</b> (2)
...
![Mode de création de lien : matériau compact](link-creation-modes.resources/link-creation-modes-05.gif "Mode de création de lien : matériau compact"){zoomable="yes"}

*Cliquer pour agrandir*

![](link-creation-modes.resources/link-creation-modes-06.png) <b>Matériau compact</b> (3)
...
Vous pouvez basculer entre les modes à tout moment dans la barre d&#39;outils graphe en cliquant sur le bouton ![](link-creation-modes.resources/link-creation-modes-07.png) <b>Mode de création de lien</b> ou à l&#39;aide des raccourcis clavier répertoriés ci-dessus.
...
|  | <div><img data-preserve-html="true" height="23" src="link-creation-modes.resources/link-creation-modes-02.png"/></div> Standard | <div><img data-preserve-html="true" height="23" src="link-creation-modes.resources/link-creation-modes-04.png"/></div> Compacter | <div><img data-preserve-html="true" height="23" src="link-creation-modes.resources/link-creation-modes-06.png"/></div> Matériau compact |
| --- | --- | --- | --- |
...
![Capsule de groupe sur le nœud](link-creation-modes.resources/link-creation-modes-08.png "Capsule de groupe sur le nœud"){zoomable="yes"}
...
![Attribut de groupe](link-creation-modes.resources/link-creation-modes-09.png "Attribut de groupe"){zoomable="yes"}
...
![Attribut d&#39;utilisation](link-creation-modes.resources/link-creation-modes-10.png "Attribut d&#39;utilisation"){zoomable="yes"}
