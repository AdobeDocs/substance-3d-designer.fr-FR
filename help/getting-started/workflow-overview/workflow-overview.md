...
![Forme simple dans le graphe Substance](workflow-overview.resources/simpleshape.png "Forme simple dans le graphe Substance"){width="512px" zoomable="yes"}
...
![Fonction avancée](workflow-overview.resources/pixel-function.png "Fonction avancée"){width="512px" zoomable="yes"}
