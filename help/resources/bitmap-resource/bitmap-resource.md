---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-designer/resources/bitmap-resource.html"
breadcrumb-title: ''
description: Apprenez à importer, créer et utiliser des images bitmap dans Substance 3D Designer pour créer des matériaux basés sur des textures.
...
Une ressource bitmap est une ressource contenue dans un pack de Substances. Il est différent du nœud bitmap atomique [. Le nœud bitmap atomique](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/bitmap/bitmap.md) est une représentation spécifique de ce bitmap à l&#39;intérieur[d&#39;un graphe de Substance](../../compositing-graphs/substance-compositing-graphs.md).

Les images bitmap font partie des ressources hors Graphe les plus courantes dans Substance 3D Designer. Leur utilisation relève généralement de l’une des catégories suivantes :

* Map bakée [bakée en interne par Designer](../../bakers/bakers.md) ou en externe par une autre application.
* Une texture d’assistant, comme un motif, une carte usure/salissures ou une décalcomanie.
...
La façon dont les bitmaps sont stockés dans SBS dépend de si vous [liez ou importez les bitmaps. Assurez-vous d&#39;abord de bien connaître le concept.](../../resources/importing-linking-and-new/importing-linking-and-new-resources.md) Les bitmaps importés peuvent être modifiés à l&#39;aide des [outils de peinture bitmap](../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md).
...
Dans les [fichiers SBSAR](../../compositing-graphs/publishing-asset-files/publishing-substance-3d-asset-files-sbsar.md), les bitmaps sont incorporés, ce qui signifie qu&#39;ils ont un impact important sur la taille finale des fichiers SBSAR. Pour en savoir plus sur l’impact sur la taille des fichiers, consultez cette page. Lors de la publication de fichiers SBSAR, seules les images bitmap utilisées pour calculer la sortie d’un graphe sont incorporées. Toutes les images bitmap inutilisées sont optimisées et exclues du package SBSAR final, sans effet sur la taille du fichier.
...
* Définissez vos résolutions pour qu&#39;elles soient conformes à la puissance 2, ce qui signifie que vous devez suivre la taille de texture standard en temps réel comme <b>256, 512, 1024,2048,</b>, etc. Designer redimensionnera les textures en dehors de cette plage à la résolution la plus proche. Notez qu’il n’est pas nécessaire qu’elles soient dans des proportions carrées.
...
* Assurez-vous de <b>configurer votre mode colorimétrique correctement</b>, selon que vous avez besoin d&#39;une couleur, de niveaux de gris ou d&#39;un canal Alpha.
...
Consultez la page [Directives de réduction de la taille des fichiers](../../best-practices/filesize-reduction-gui/filesize-reduction-guidelines.md) dans la section [Pratiques recommandées](../../best-practices/best-practices.md) pour nos recommandations concernant la réduction de la taille des fichiers des bitmaps incorporés dans [ressources Substance 3D publiées (SBSAR)](../../compositing-graphs/publishing-asset-files/publishing-substance-3d-asset-files-sbsar.md).
