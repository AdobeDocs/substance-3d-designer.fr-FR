...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Graphes ([graphes de Substance](../../compositing-graphs/substance-compositing-graphs.md), [graphes de fonction de Substance](../../function-graphs/function-graphs.md) | <div><img alt="(coche)" data-preserve-html="true" src="../../assets/check.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="../../assets/error.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="../../assets/error.svg"/></div> |
...
| scènes 3D, [polices](../../resources/font-resource/font-resource.md) | <div><img alt="(erreur)" data-preserve-html="true" src="../../assets/error.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="../../assets/error.svg"/></div> | <div><img alt="(coche)" data-preserve-html="true" src="../../assets/check.svg"/></div> |
| Est créé à côté du fichier SBS | <div><img alt="(coche)" data-preserve-html="true" src="../../assets/check.svg"/></div> | <div><img alt="(coche)" data-preserve-html="true" src="../../assets/check.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="../../assets/error.svg"/></div> |
