...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Graphiques ([graphiques de Substance](../../compositing-graphs/substance-compositing-graphs.md), [graphiques de fonction de Substance](../../function-graphs/function-graphs.md) | <div><img alt="(coche)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/check.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/error.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/error.svg"/></div> |
...
| Est créé en regard du fichier SBS | <div><img alt="(coche)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/check.svg"/></div> | <div><img alt="(coche)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/check.svg"/></div> | <div><img alt="(erreur)" data-preserve-html="true" src="importing-linking-and-new-resources.resources/error.svg"/></div> |
...
![&#39;Ressource supprimée en cours d&#39;utilisation&#39; avertissement](importing-linking-and-new-resources.resources/importing-linking-and-new-resources-01.png "&#39;Ressource supprimée en cours d&#39;utilisation&#39; avertissement"){width="512px"}
