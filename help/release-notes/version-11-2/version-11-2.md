...
**Substance 3D Designer 11.2** a légèrement changé de nom et est maintenant connecté à Adobe Creative Cloud. Elle apporte la toute première version de Graphe Substance model, la fonctionnalité Envoyer vers, un certain nombre de nœuds basés sur Raytrace et certaines modifications de l’interface utilisateur.

Date de publication : *23 juin 2021*

## Principales fonctionnalités

### Nouveaux Graphes Substance models

Un tout nouveau type de Graphe, le Graphe Substance model, est disponible. Il vous permet de créer des modèles 3D procéduraux à l’aide d’une interface de nœud familière.
...
Aucune version de Designer n’est terminée sans nouveaux nœuds. En s&#39;appuyant sur la force phénoménale du Rendu PBR, 5 nouveaux nœuds basés sur la RT nous rejoignent dans cette version.
