...
**Substance Designer 2020.1** inclut un nouvel éditeur de raccourcis, un plug-in MaterialX et de nombreuses nouvelles améliorations pour la gestion des couleurs avec des fonctionnalités Adobe Color Engine et nouveaux boulangers.
...
### Nouvel éditeur de raccourcis pour la création de nœuds

![](../../../assets/banner-shortcuts.png)

Dans cette version, nous introduisons un nouvel éditeur de raccourcis qui permet de définir des raccourcis clavier pour accélérer la création de nœuds dans les différents modes graphiques.

Le nouvel éditeur de raccourcis est accessible dans les préférences principales via **Édition > Préférences > Raccourcis**. Par défaut, tous les champs de raccourci sont vides.

* **Raccourcis pour chaque type de graphique**\
  Il est possible de définir un raccourci pour chaque type de graphique disponible dans la Substance Designer, qu’il s’agisse d’un graphique de composition classique ou d’un graphique plus avancé, tel que les fonctions et le langage MDL.

  ![](../../../assets/shortcuts-graph-type.png)
* **Attribuer des raccourcis à la fois pour les nœuds atomiques et les filtres personnalisés**\
  Par défaut, l’interface affiche les nœuds atomiques pour chaque type de graphique. L’utilisation du champ de recherche permet d’affiner la liste, mais également de rendre accessibles les filtres et les nœuds de bibliothèque personnalisés :

  ![](../../../assets/shortcut-node-search.gif)
* **Création d&#39;un raccourci**\
  Pour créer un raccourci pour un nœud spécifique, il vous suffit de cliquer dans le champ de texte en regard de son nom et de saisir les touches demandées sur le clavier. Pour effacer un raccourci, utilisez le bouton en forme de croix.
