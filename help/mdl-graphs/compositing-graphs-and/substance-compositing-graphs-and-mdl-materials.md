...
![Entrées de graphique MDL exposées](substance-compositing-graphs-and-mdl-materials.resources/mdl-graph-inputs-samplers.png "Entrées de graphique MDL exposées")
...
![Graphique de Substance à partir du fichier SBS dans le graphique MDL](substance-compositing-graphs-and-mdl-materials.resources/mdl-sbs-instance-hl.png "Graphique de Substance à partir du fichier SBS dans le graphique MDL")
...
![Graphique de Substance à partir du fichier SBSAR dans le graphique MDL](substance-compositing-graphs-and-mdl-materials.resources/mdl-sbsar-instance-hl.png "Graphique de Substance à partir du fichier SBSAR dans le graphique MDL")
