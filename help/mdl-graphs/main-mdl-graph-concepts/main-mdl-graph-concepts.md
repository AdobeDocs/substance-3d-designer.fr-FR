...
*Nœud racine dans un graphique MDL et ses propriétés affichées dans le [panneau Propriétés](https://helpx.adobe.com/fr/substance-3d/unlisted/documentation/sddoc/parameters-ui-129368153.html)* *5&rbrace;*
...
* si le menu Nœud s&#39;affiche en *faisant glisser un lien* hors d&#39;un connecteur *output*, la liste inclut les nœuds pour lesquels le type de données *première entrée* correspond au type de données *sortie* sélectionné
* si le menu Nœud s&#39;affiche en *faisant glisser un lien* à partir d&#39;un connecteur *d&#39;entrée*, la liste inclut les nœuds dont le type de données *de sortie* correspond au type de données *d&#39;entrée* sélectionné

![Création de nœud filtrée](../../assets/mdl-filtered-node-creation.gif "Création de nœud filtrée")

*Création de nœuds filtrée dans le graphique MDL. Notez que la liste change en fonction du type de valeur pour le connecteur*

## Entrées et textures du graphique

Les matériaux MDL peuvent recevoir des données de sources externes, sous la forme de valeurs et de textures par exemple. Pour ce faire, <b>exposez un nœud</b>, contrairement au [graphique de Substance](../../compositing-graphs/substance-compositing-graphs.md) où des nœuds d&#39;entrée dédiés existent à cet effet.

Les données peuvent être transmises au nœud exposé selon son *type*. Par exemple, les valeurs Float peuvent être transmises à un nœud <b>float</b> exposé et une texture peut être transmise à un nœud <b>color</b> exposé (dans ce cas, les valeurs RVBA du pixel échantillonné sont transmises en tant que valeur de couleur).

![Entrées de graphique affichées](../../assets/mdl-graph-inputs-samplers.png "Entrées de graphique affichées")

*Les nœuds exposés créent des entrées de graphique qui sont à la fois des entrées de valeur brute et des échantillonneurs pour les textures*
