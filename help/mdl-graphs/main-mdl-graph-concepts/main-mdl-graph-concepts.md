...
Nœud racine de ![Graphe MDL](../../assets/mdl-root-hl.png "de Graphe MDL")

*Nœud racine dans un Graphe MDL et ses propriétés affichées dans le [panneau Propriétés](../../interface/properties/properties.md)* *4&rbrace;*
