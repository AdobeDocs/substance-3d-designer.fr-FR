...
![Ressources MDL dans la bibliothèque](mdl-library.resources/mdl-library.png "Ressources MDL dans la bibliothèque")
...
![Matériaux MDL dans la vue 3D](mdl-library.resources/mdl-apply-in-3dview-material-list.png "Matériaux MDL dans la vue 3D")
