...
Substance 3D Designer peut être configuré pour utiliser [OpenColorIO](https://opencolorio.org/) (OCIO) ou Adobe Color Engine (ACE) pour la gestion des couleurs. Cela vous permet d&#39;avoir des transformes de couleurs et un affichage d&#39;image *cohérents* dans plusieurs applications.

Dans ce mode, Designer fonctionnera en interne avec les couleurs du **RGB linéaire**. Étant donné que le nombre de bits par pixel 8 n&#39;est généralement pas suffisant pour représenter des couleurs linéaires, il est recommandé d&#39;utiliser la profondeur *au moins* **16 bits** pour les textures de couleurs dans le [graphe](../compositing-graphs/substance-compositing-graphs.md).
...
> Les utilisateurs ACE Adobes doivent s&#39;assurer que les profils ICC sélectionnés *dans le système d&#39;exploitation* correspondent à *leurs* moniteurs.
...
Lors de l&#39;utilisation du mode OpenColorIO pour la gestion des couleurs, Designer utilise les informations stockées dans un <b>fichier de configuration</b> (*\*.config*) pour effectuer des transformes de couleurs, identifier les espaces colorimétriques et définir des valeurs par défaut.
...
L&#39;option « Brut » écrit les données d&#39;image *telles quelles* à partir du graphe, c&#39;est-à-dire en utilisant l&#39;espace colorimétrique de travail du graphe. Cela signifie que les options <b>Brut</b> et <b>sRVB</b> entraînent la *même sortie colorimétrique*.

Par défaut, l&#39;option « sRGB » est définie pour les sorties qui contiennent *des informations de couleur* (par exemple, Base color, Emissive), et l&#39;option « Raw » est définie pour les sorties qui contiennent *des données pures* (par exemple, Rugosité, Métallique, Height, Normal). Comme expliqué ci-dessus, ces valeurs par défaut produisent en fait les mêmes couleurs et sont définies uniquement pour *différencier l&#39;utilisation finale* de leurs sorties.

L&#39;option <b>Linéaire</b> est la *seule* qui entraîne l&#39;application d&#39;un *transforme de couleur* à l&#39;image. Elle ne peut être utilisée que pour les images <b>Plage dynamique élevée</b> (HDR), qui utilisent généralement la *précision en virgule flottante* (c&#39;est-à-dire le nombre de bits par pixel 16F ou 32F) dans l&#39;espace colorimétrique linéaire. Cela permet d’utiliser ces images dans un large éventail d’espaces colorimétriques et d’environnements de production.
...
Vous pouvez également attribuer un espace colorimétrique (OCIO) ou joindre un profil ICC (Adobe ACE) aux images *enregistrées* à partir de [vue 2D](../interface/2d-view/2d-view.md).

![Options d’exportation vue 2D](color-management.resources/2019-3-0-clr-mgt-save-image.png "Options d’exportation vue 2D")

## Vues 2D et 3D

### Afficher la barre d’outils

Vous pouvez *activer/désactiver la gestion des couleurs* et modifier la *transforme d&#39;affichage* de l&#39;affichage à tout moment à l&#39;aide du menu déroulant de la barre d&#39;outils d&#39;affichage.

![Paramètre d&#39;espace colorimétrique dans vue 2D](color-management.resources/2019-3-0-clr-mgt-display-toolbar.png "Paramètre d&#39;espace colorimétrique dans vue 2D"){width="512px"}
...
Lors de l&#39;utilisation d&#39;une configuration OpenColorIO où l&#39;espace colorimétrique linéaire de la scène est *non* sRVB linéaire, telle que la configuration [ACE](https://acescentral.com/t/getting-started-with-aces/1372), l&#39;environnement affichera *des couleurs incorrectes*.

Dans ce cas, l&#39;espace colorimétrique pour les environnements HDRI de bibliothèque doit être défini *manuellement* dans les propriétés d&#39;environnement, disponibles dans le menu <b>Environnement</b> du panneau vue 3D.

![Paramètre d&#39;espace colorimétrique de l&#39;environnement vue 3D](color-management.resources/2019-3-0-clr-mgt-hdri-env.png "Paramètre d&#39;espace colorimétrique de l&#39;environnement vue 3D"){width="512px"}
...
Ils sont utiles lorsque vous travaillez avec des graphes créés *sans* gestion des couleurs ou des matériaux de la bibliothèque [Ressources Substance 3D](https://substance3d.adobe.com/assets).
