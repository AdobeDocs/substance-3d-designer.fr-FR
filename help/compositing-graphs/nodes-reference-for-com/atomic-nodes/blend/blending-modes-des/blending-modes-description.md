...
![Mode de fusion : Copier](blending-modes-description.resources/blending-modes-description-01.png "Mode de fusion : Copier"){zoomable="yes"}
...
![Mode de fusion : Copier (2)](blending-modes-description.resources/blending-modes-description-02.png "Mode de fusion : Copier (2)"){zoomable="yes"}
...
![Mode de fusion : Ajouter (Densité linéaire)](blending-modes-description.resources/blending-modes-description-03.png "Mode de fusion : Ajouter (Densité linéaire)"){zoomable="yes"}
...
![Mode de fusion : Soustraction](blending-modes-description.resources/blending-modes-description-04.png "Mode de fusion : Soustraction"){zoomable="yes"}
...
![Mode de fusion : Produit](blending-modes-description.resources/blending-modes-description-05.png "Mode de fusion : Produit"){zoomable="yes"}
...
![Mode de fusion : Ajouter sub](blending-modes-description.resources/blending-modes-description-06.png "Mode de fusion : Ajouter sub"){zoomable="yes"}

## Max. (Éclaircir)

Le mode de fusion *Max* sélectionnera la valeur la plus élevée entre l&#39;arrière-plan et le premier plan.

![Mode de fusion : Max (Éclaircir)](blending-modes-description.resources/blending-modes-description-07.png "Mode de fusion : Max (Éclaircir)"){zoomable="yes"}

## Min. (obscurcir)

Le mode de fusion *Min* sélectionnera la valeur inférieure entre l&#39;arrière-plan et le premier plan.

![Mode de fusion : Min (Obscurcir)](blending-modes-description.resources/blending-modes-description-08.png "Mode de fusion : Min (Obscurcir)"){zoomable="yes"}
...
![Mode de fusion : Basculer](blending-modes-description.resources/blending-modes-description-01.png "Mode de fusion : Basculer"){zoomable="yes"}
...
![Mode de fusion : Division](blending-modes-description.resources/blending-modes-description-09.png "Mode de fusion : Division"){zoomable="yes"}
...
![Mode de fusion : Incrustation](blending-modes-description.resources/blending-modes-description-10.png "Mode de fusion : Incrustation"){zoomable="yes"}
...
![Mode de fusion : Écran](blending-modes-description.resources/blending-modes-description-11.png "Mode de fusion : Écran"){zoomable="yes"}
...
![Mode de fusion : Lumière tamisée](blending-modes-description.resources/blending-modes-description-12.png "Mode de fusion : Lumière tamisée"){zoomable="yes"}
