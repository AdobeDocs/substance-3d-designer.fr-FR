...
![Nœud atomique : réorganisation des canaux](channel-shuffle.resources/channel-shuffle-01.png "Nœud atomique : réorganisation des canaux"){width="200px"}
...
|  |  |
| --- | --- |
| <b>Canal rouge</b> *Nombre entier* | Choisissez le canal source à insérer dans la couche rouge de l’image de sortie. |
| <b>Canal vert</b> *Entier* | Choisissez la couche source à insérer dans la couche verte de l’image de sortie. |
| <b>Canal bleu</b> *Nombre entier* | Choisissez le canal source à insérer dans la couche bleue de l’image de sortie. |
| <b>Canal Alpha</b> *Nombre entier* | Choisissez le canal source à insérer dans le Canal Alpha de l’image de sortie. |
