...
![Nœud atomique : Courbe](curve.resources/curve-01.png "Nœud atomique : Courbe"){width="200px"}
...
![](curve.resources/curve-04.png) Réinitialisez le mode de point à la valeur par défaut.

![](curve.resources/curve-05.png) Verrouillez/déverrouillez les 2 gestionnaires Bézier afin que l&#39;utilisateur puisse les déplacer ensemble ou indépendamment.

![](curve.resources/curve-06.png) Les deux côtés du point sont contrôlés par un gestionnaire Bézier.

![](curve.resources/curve-07.png) Le côté droit du point est contrôlé par un gestionnaire Bézier tandis que le côté gauche reste plat.

![](curve.resources/curve-08.png) Le côté gauche du point est contrôlé par un gestionnaire Bézier tandis que le côté droit reste plat.

![](curve.resources/curve-09.png) Les côtés des points restent plats

![](curve.resources/curve-10.gif)

### Afficher l’histogramme d’entrée

Vous pouvez afficher/masquer l&#39;histogramme de votre saisie en cliquant simplement sur ![](curve.resources/curve-11.png)
...
En mode Courbe RGB, vous pouvez masquer/afficher les courbes de couche individuelles en appuyant/déplaçant ![](curve.resources/curve-14.png) :
...
Dans ce cas, vous pouvez utiliser le bouton ![](curve.resources/curve-20.png) pour adapter la taille au contenu.

Le bouton ![](curve.resources/curve-21.png) réinitialise le niveau de zoom à 1
