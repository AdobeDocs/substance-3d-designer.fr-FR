...
breadcrumb-title: ''
description: Utilisez le nœud Niveaux pour régler la luminosité, le contraste et la gamme de tons des textures afin de corriger et d’améliorer les couleurs.
...
![Nœud atomique : niveaux](../../../../assets/comp_levels_1.png "Nœud atomique : niveaux"){width="200px"}
...
Il s’agit de l’un des nœuds principaux les plus utiles de Substance 3D Designer. Il est très souvent utilisé pour remapper et ajuster les valeurs d’un graphique, car il fournit l’interface la plus précise et la plus précise pour modifier les valeurs.
...
|  |  |
| --- | --- |
| <b>Niveau bas</b> *Float/Float4* | Définit les niveaux de faible luminosité de l’image d’entrée. Remappe les valeurs d’entrée Faible pour obtenir un noir complet. |
| <b>Niveau élevé</b> *Float/Float4* | Définit les niveaux de tons clairs de l’image d’entrée.  Les remappages saisissent des valeurs élevées pour obtenir un blanc complet. |
| <b>Niveau en milieu</b> *Float/Float4* | Définit les niveaux de tons moyens de l’image d’entrée.  Remappe les valeurs intermédiaires d’entrée pour obtenir un gris moyen. |
| <b>Niveau bas</b> *Float/Float4* | Définit les niveaux de surbrillance de l’image de sortie.  Permet de fixer les valeurs Noir en sortie pour définir la limite. |
| <b>Niveau supérieur</b> *Float/Float4* | Définit les niveaux de surbrillance de l’image de sortie.  Permet de fixer des valeurs de blanc en sortie pour définir une limite. |
