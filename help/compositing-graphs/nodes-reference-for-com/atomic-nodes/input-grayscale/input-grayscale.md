...
breadcrumb-title: ""
description: Utilisez le nœud Niveaux de gris d’entrée pour créer des paramètres d'entrée en niveaux de gris pour les graphes de Substance qui peuvent être exposés et ajustés par les utilisateurs.
...
# Niveaux de gris en entrée

<table>
<tr style="border: 0;">
<td style="border: 0;" valign="top">

![Noeud atomique : Niveaux de gris d&#39;entrée](input-grayscale.resources/comp_inputgrayscale_1.png "Noeud atomique : Niveaux de gris d&#39;entrée"){width="20%"}
...
Voir aussi : [Couleur d&#39;entrée](../input-color/input-color.md), [Valeur d&#39;entrée](../input-value/input-value.md)

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="Info-bulle Niveaux de gris en entrée" /></div>

## Paramètres

Par défaut, la couleur d’entrée ou les niveaux de gris renvoient du noir si aucun élément n’est connecté. Vous pouvez soit définir une valeur par défaut différente, soit faire glisser une [ressource bitmap](../../../../resources/importing-linking-and-new/importing-linking-and-new-resources.md) de l&#39;[Explorateur](../../../../interface/the-explorer-window/the-explorer-window.md) sur le Noeud d&#39;entrée de votre graphe pour prévisualiser ces données dans l&#39;emplacement. Cela ne fonctionne que pour les entrées Couleur et Niveaux de gris. La valeur par défaut est persistante lorsqu’elle est utilisée dans d’autres contextes, le bitmap d’aperçu est ignoré partout ailleurs.

Si vous voulez le voir avec les sorties d&#39;un autre Graphe, vous devrez soit exporter ce Graphe vers Bitmap pour la méthode ci-dessus, soit utiliser l&#39;édition « In-Context ».
...
![Entrée principale dans le graphe de Substance](input-grayscale.resources/node-primary-input.png){width="20%"}
