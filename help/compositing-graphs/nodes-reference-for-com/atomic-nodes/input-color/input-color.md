...
breadcrumb-title: ""
description: Utilisez le nœud Couleur d’entrée pour créer des paramètres d'entrée de couleur pour les graphes de Substance qui peuvent être exposés et ajustés par les utilisateurs.
...
![Noeud atomique : couleur d&#39;entrée](input-color.resources/comp_inputcolor_1.png "Noeud atomique : couleur d&#39;entrée"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="Info-bulle Couleur d’entrée" /></div>
...
![Entrée principale dans le graphe de Substance](input-color.resources/node-primary-input.png){width="20%"}
