...
![Noeud atomique : valeur d&#39;entrée](input-value.resources/comp_inputnumeric_1.png "Noeud atomique : valeur d&#39;entrée")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-value.resources/input-value-tooltip.gif" alt="Info-bulle de la valeur d’entrée" /></div>
...
![Entrée principale dans le graphe de Substance](input-value.resources/node-primary-input.png)
