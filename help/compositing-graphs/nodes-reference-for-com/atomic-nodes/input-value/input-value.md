...
breadcrumb-title: ""
description: Utilisez le nœud Valeur d’entrée pour créer des paramètres d'entrée de valeur pour les graphes de Substance qui peuvent être exposés et ajustés par les utilisateurs.
...
![Noeud atomique : valeur d&#39;entrée](input-value.resources/comp_inputnumeric_1.png "Noeud atomique : valeur d&#39;entrée"){width="20%"}
...
Voir aussi : [Couleur d&#39;entrée](../input-color/input-color.md), [Niveaux de gris d&#39;entrée](../input-grayscale/input-grayscale.md)

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="Info-bulle de la valeur d’entrée" /></div>
...
![Entrée principale dans le graphe de Substance](input-value.resources/node-primary-input.png){width="20%"}
