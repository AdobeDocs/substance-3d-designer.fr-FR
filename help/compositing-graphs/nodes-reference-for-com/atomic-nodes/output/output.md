...
![Noeud atomique : Sortie](output.resources/comp_output_1.png "Noeud atomique : Sortie")
...
<div data-preserve-html="true" style="text-align: center;"><img src="output.resources/output-tooltip.gif" alt="info-bulle de sortie" /></div>
