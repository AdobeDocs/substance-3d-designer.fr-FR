...
| <b>Mappage normal</b> *Booléen* | Spécifie si les images fournies à l&#39;<b>entrée d&#39;Atlas en grille</b> ou à l&#39;<b>entrée de motif #</b> sont des mappages normaux.<br><br>Cette opération est nécessaire pour activer le traitement requis pour gérer correctement les vecteurs normaux et les appliquer aux formes. |
| <b>Format normal d&#39;entrée</b> *Nombre entier* | Le format des cartes de normales fournies à l&#39;<b>entrée d&#39;Atlas en grille</b> ou à l&#39;<b>entrée de motif #</b>.<br><br>Inverse efficacement la couche verte.<br><br>-<b>DirectX:</b> L&#39;axe Y est orienté vers le haut.<br>-<b>OpenGL:</b> L&#39;axe Y est orienté vers le bas. |
...
| <b>Réglage TSL</b> *Float3* | Décalage appliqué uniformément à la teinte, la saturation et la luminance (TSL) de toutes les formes. |
| <b>HSL aléatoire</b> *Float3* | Décalage aléatoire, positif ou négatif, appliqué à la teinte, à la saturation et à la luminance (TSL) des formes, jusqu’aux valeurs spécifiées. |
...
<table style="margin-top: 32px; margin-bottom: 32px; border: none">
    ...
    <tr style="border: 0; background: transparent">
        <td style="width: 33%; border: 0; background: transparent">
            <img src="./shape-splatter-v2-mapper-color.resources/shape-splatter-v2-mapper-color-tiling.gif" /><br><i>Réglage des limites avec mappage triplanaire</i>
        </td>
        <td style="width: 33%; border: 0; background: transparent">
        ...
        <td style="width: 33%; border: 0; background: transparent">
            <img src="./shape-splatter-v2-mapper-color.resources/shape-splatter-v2-mapper-color-graph.png" /><br><i>Nœud dans le contexte d'un graphique</i> » /&gt;
        </td>
    </tr>
</table>
