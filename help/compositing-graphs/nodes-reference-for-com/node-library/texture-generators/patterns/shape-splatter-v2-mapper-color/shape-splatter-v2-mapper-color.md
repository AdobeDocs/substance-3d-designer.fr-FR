...
description: Designer > graphes de composition de Substance > Référence des nœuds pour les graphes de composition de Substance > Bibliothèque de nœuds > Générateur > Motif > Couleur du mappeur d’éclaboussures de forme v2
...
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|:-------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Mode Projection</b> *Entier* | Méthode de projection des images d&#39;entrée sur les formes :<br><br>- <b>À partir d&#39;UV à éclaboussures :</b> Utilisez les UV fournis par le nœud &#39;Shape splatter v2&#39;.<br>- <b>Triplanar :</b> Utilisez projection triplanaire pour mapper les images sur les axes XYZ locaux des formes.<br>- <b>Fonction personnalisée :</b> Créez un graphe de fonction pour définir le mappage des images sur les formes. |
| <b>Fonction personnalisée</b> *Flottant4* | Spécifie la couleur RVBA par pixel des formes en tant que Flottant 4.<br><br>Les variables suivantes sont disponibles :<br>- <code>shape.position.os</code> (Flottant 3) Position de la surface de la forme dans l&#39;espace objet.<br>- <code>shape.position.ws</code> (Flottant 3) Position de la surface de forme dans espace monde*.<br>- <code>shape.normal.os</code> (Flottant 3) Les normales de la surface de la forme dans l&#39;espace objet.<br> - <code>shape.normal.ws</code> (Flottant 3) Les normales de la surface de la forme dans espace monde*.<br>- <code>shape.id</code> (Flottant) identifiant unique de la forme.<br>- <code>matériau.id</code> (Flottant) ID de matériau de la surface de la forme, définie par le nœud « Shape splatter v2 ».<br><br>* : l&#39;espace monde de la forme est centré sur son pivot et ne tient pas compte de l&#39;height de la forme. Cela signifie que la seule différence avec l’espace objet est l’orientation.<br><br>Si l&#39;échantillonnage des entrées du nœud de mappeur « Shape splatter v2 » est nécessaire, ces emplacements d&#39;entrée de nœud <b>Échantillon de couleur</b> peuvent être utilisés :<br>- 0 : Atlas en grille<br>- 1-8 : Entrée de motif 1-8 |
| <b>La map normal</b> *Booléen* | Spécifie si les images fournies à l&#39;<b>entrée Atlas en grille</b> ou à l&#39;<b>entrée Motif #</b> sont des maps normal.<br><br>Cette opération est nécessaire pour activer le traitement requis pour gérer correctement les vecteurs normaux et les appliquer aux formes. |
| <b>Format normal d&#39;entrée</b> *Entier* | Le format des maps normal fournies pour l&#39;<b>entrée d&#39;Atlas en grille</b> ou l&#39;<b>entrée de motif #</b>.<br><br>inverse efficacement le canal vert.<br><br>-<b>DirectX:</b> L&#39;axe Y pointe vers le haut.<br>-<b>OpenGL:</b> L&#39;axe Y pointe vers le bas. |
...
| <b>Réglage TSL</b> *Flottant3* | Décalage uniformément appliqué à la teinte, la saturation et la luminance (TSL) de toutes les formes. |
| <b>TSL aléatoire</b> *Flottant3* | Décalage aléatoire, positif ou négatif, de la teinte, de la saturation et de la luminance (TSL) des formes, jusqu’aux valeurs spécifiées. |
