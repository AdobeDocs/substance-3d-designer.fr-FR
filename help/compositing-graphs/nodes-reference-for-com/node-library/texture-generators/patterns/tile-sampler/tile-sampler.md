...
<table style="margin-top: 32px; margin-bottom: 32px">
    <tr style="border: 0">
        <td style="border: 0; background: transparent">
            <img src="tile-sampler.resources/tile-sampler-02.png" /><br><i>L'exemple montre comment les paramètres sont pilotés par les maps d'entrée (répartition du motif, échelle, rotation).</i>
        </td>
    </tr>
</table>
