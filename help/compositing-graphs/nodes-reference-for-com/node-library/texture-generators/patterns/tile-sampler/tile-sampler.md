...
<table style="margin-top: 32px; margin-bottom: 32px">
    <tr style="border: 0">
        <td style="border: 0; background: transparent">
            <img src="tile-sampler.resources/tilesampler-ex2.png" /><br><i>L'exemple montre comment les paramètres sont pilotés par les cartes d'entrée (distribution de motif, échelle, rotation).</i>
        </td>
    </tr>
</table>
