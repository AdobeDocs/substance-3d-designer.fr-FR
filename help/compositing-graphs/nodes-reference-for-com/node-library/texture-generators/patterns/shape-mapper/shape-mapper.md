...
![Mappeur de formes - Icône](../../../../../../assets/shape_mapper.png "Mappeur de formes - Icône"){width="200px"}
...
La projection déforme l’image pour qu’elle suive le contour de la forme et l’adapte exactement à un nombre spécifié de fois sans espaces.
...
|  |  |
| --- | --- |
| <b>Entrée</b> *Niveaux de gris* | Motif à placer le long de la forme. |

## Sorties

|  |  |
| --- | --- |
| <b>Sortie</b> *Niveaux de gris* | Résultat de la projection du motif le long de la forme, sous forme d’image bitmap en niveaux de gris. |
...
| <b>Symétrie booléenne un sur deux</b> | Retournez une forme sur deux verticalement. |
| Entier <b>mode de filtrage</b> | La méthode de filtrage appliquée aux motifs placés le long de la forme:<ul data-preserve-html="true"> <li data-preserve-html="true"><i>Au plus proche :</i> applique la valeur du pixel projeté le plus proche telle quelle, ce qui donne un aspect plus net mais crénelé.</li> <li data-preserve-html="true"><i>Bilinéaire :</i> applique un filtre bilinéaire pour interpoler le pixel projeté avec ses voisins, pour un aspect plus lisse mais plus flou.</li> </ul> |
| <b>Expansion non carrée</b> booléenne | Dans les images non carrées, la forme générée reste carrée et étend la génération d’image aux limites de l’image. |
