...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-leaks.resources/grungeleaks-variant2.jpg" class="modal-image" alt="Fuites d&apos;Usure/salissures - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-leaks.resources/grungeleaks-variant.jpg" class="modal-image" alt="Fuites d&apos;Usure/salissures - Exemple 2" />
        </td>
