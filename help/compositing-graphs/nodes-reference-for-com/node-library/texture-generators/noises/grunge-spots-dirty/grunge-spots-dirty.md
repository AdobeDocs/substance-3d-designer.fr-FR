...
# Usure/salissures des taches sales
...
Le nœud **Usure/salissures Spots Dirty** génère un mappage usure/salissures semblable aux points de dirt.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant2.jpg" class="modal-image" alt="Taches d&apos;Usure/salissures sales - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant.jpg" class="modal-image" alt="Taches d&apos;Usure/salissures sales - Exemple 2" />
        </td>
