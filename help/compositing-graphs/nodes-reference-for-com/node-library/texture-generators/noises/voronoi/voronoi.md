...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant2.jpg" class="modal-image" alt="Voronoi - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant3.jpg" class="modal-image" alt="Voronoi - Exemple 2" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant5.jpg" class="modal-image" alt="Voronoi - Exemple 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant.jpg" class="modal-image" alt="Voronoi - Exemple 4" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant4.jpg" class="modal-image" alt="Voronoi - Exemple 5" />
        </td>
        <td style="border: 0;">
            <img src="voronoi.resources/voronoi-variant6.jpg" class="modal-image" alt="Voronoi - Exemple 6" />
        </td>
    </tr>
</table>
