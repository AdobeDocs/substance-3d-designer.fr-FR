...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant.jpg" class="modal-image" alt="bruit 3D à arête fractale - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant2.jpg" class="modal-image" alt="bruit 3D à arête fractale - Exemple 2" />
        </td>
