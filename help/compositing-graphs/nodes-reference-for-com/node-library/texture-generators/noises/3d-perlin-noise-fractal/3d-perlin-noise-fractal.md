...
| <b>Opacité globale</b> <i>Flottant</i> | Contrôle la <i>plage</i> des valeurs du bruit de Perlin 3D fractal <i>autour</i> de la <b>valeur de base</b>. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dfractal.gif" class="modal-image" alt="bruit Perlin 3D Fractal - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dperlinnoisefractal-variant.jpg" class="modal-image" alt="bruit Perlin 3D Fractal - Exemple 2" />
        </td>
        <td style="border: 0;">
            <img src="3d-perlin-noise-fractal.resources/3dperlinnoisefractal-variant2.jpg" class="modal-image" alt="bruit Perlin 3D Fractal - Exemple 3" />
        </td>
    </tr>
</table>
