...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/dirt_2_1.png" class="modal-image" alt="Dirt 2 - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Dirt 2 - Exemple 2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="Dirt 2 - Exemple 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Dirt 2 - Exemple 4" />
        </td>
