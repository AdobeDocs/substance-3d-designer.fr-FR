---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-3.html"
breadcrumb-title: ''
description: Utilisez le nœud Dirt 3 pour générer des motifs de dirt intermédiaires afin de créer des détails de surface altérés et des effets d’accumulation.
...
![Dirt 3 - Icône](dirt-3.resources/dirt_3.png "Dirt 3 - Icône"){width="200px"}
...
Variante des bruits granuleux de <b>Dirt</b>.
...
![Dirt 3 - Exemple 1](dirt-3.resources/dirt_3_1.png "Dirt 3 - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 3 - Exemple 2](dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso0.gif "Dirt 3 - Exemple 2"){zoomable="yes"}
...
![Dirt 3 - Exemple 3](dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso1.gif "Dirt 3 - Exemple 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 3 - Exemple 4](dirt-3.resources/noise_dirt_3_v2_speed0.3_aniso0.6.gif "Dirt 3 - Exemple 4"){zoomable="yes"}
