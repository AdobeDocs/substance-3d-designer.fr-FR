...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-rough-dirty.resources/grungeroughdirty-variant.jpg" class="modal-image" alt="Usure/salissures Rough Dirty - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-rough-dirty.resources/grungeroughdirty-variant2.jpg" class="modal-image" alt="Usure/salissures Rough Dirty - Exemple 2" />
        </td>
