...
breadcrumb-title: ""
description: Utilisez le nœud Usure/salissures Galvanic Small pour générer des motifs de corrosion galvanique à petite échelle pour les effets d'altération des métaux.
...
helpx_learn_topic: ""
helpx_tags: ""
title: Usure/salissures Galvanic Small
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant2.jpg" class="modal-image" alt="Usure/salissures Galvanic Small - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-small.resources/grungegalvanicsmall-variant.jpg" class="modal-image" alt="Usure/salissures Galvanic Small - Exemple 2" />
        </td>
