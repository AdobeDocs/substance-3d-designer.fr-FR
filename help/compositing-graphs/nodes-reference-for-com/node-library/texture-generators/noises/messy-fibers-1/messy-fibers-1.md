...
breadcrumb-title: ''
description: Utilisez le nœud Messy Fibres 1 pour générer des motifs de fibre de base afin de créer des détails de texture textile et de tissu.
...
![Fibres désordonnées 1 - Icône](../../../../../../assets/messy_fibers_1.png "Fibres désordonnées 1 - Icône"){width="200px"}
...
Voir aussi : [Fibres désordonnées 2](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/messy-fibers-2/messy-fibers-2.md), [Fibres désordonnées 3](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/messy-fibers-3/messy-fibers-3.md)
...
| <b>Nombre de lignes</b> Flottant | Quantité de mosaïque appliquée aux filetages de base, où une valeur plus élevée produit des filetages plus denses et plus fins. |
...
![Fibres désordonnées 1 - Icône](../../../../../../assets/messy_fibers_1_1.png "Fibres désordonnées 1 - Icône"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fibres désordonnées 1 - Exemple 2](../../../../../../assets/noise_messy_fibers_1_v2_speed0.1_aniso0.gif "Fibres désordonnées 1 - Exemple 2"){zoomable="yes"}
...
![Fibres désordonnées 1 - Exemple 3](../../../../../../assets/noise_messy_fibers_1_v2_speed0.1_aniso1.gif "Fibres désordonnées 1 - Exemple 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fibres désordonnées 1 - Exemple 4](../../../../../../assets/noise_messy_fibers_1_v2_speed0.1_aniso0.6.gif "Fibres désordonnées 1 - Exemple 4"){zoomable="yes"}
