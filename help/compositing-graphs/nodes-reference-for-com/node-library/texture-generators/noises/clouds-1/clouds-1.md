...
![Nuages 1 - Icône](clouds-1.resources/clouds_1.png "Nuages 1 - Icône"){width="200px"}
...
![Nuages 1 - Exemple 1](clouds-1.resources/clouds_1_1.png "Nuages 1 - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Nuages 1 - Exemple 2](clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso0.gif "Nuages 1 - Exemple 2"){zoomable="yes"}
...
![Nuages 1 - Exemple 3](clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso1.gif "Nuages 1 - Exemple 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Nuages 1 - Exemple 4](clouds-1.resources/noise_clouds_1_v2_speed0.3_aniso0.6.gif "Nuages 1 - Exemple 4"){zoomable="yes"}
