...
![Bruit de Perlin - Icône](perlin-noise.resources/perlin_noise.png "Bruit de Perlin - Icône"){width="200px"}
...
![Bruit de Perlin - Exemple 1](perlin-noise.resources/perlin_noise_1.png "Bruit de Perlin - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Bruit de Perlin - Exemple 2](perlin-noise.resources/noise_perlin_noise_v2_speed0.6_aniso0.gif "Bruit de Perlin - Exemple 2"){zoomable="yes"}
