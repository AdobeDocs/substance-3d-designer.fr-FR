---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/messy-fibers-3.html"
breadcrumb-title: ''
...
![Fibres désordonnées 3 - Icône](../../../../../../assets/messy_fibers_3.png "Fibres désordonnées 3 - Icône"){width="200px"}
...
| <b>Luminance aléatoire</b> flottante | Plage de luminance soustraite aléatoirement des filetages, où 1 correspond à la plage complète. |
...
![Fibres désordonnées 3 - Exemple 1](../../../../../../assets/messy_fibers_3_1.png "Fibres désordonnées 3 - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fibres désordonnées 3 - Exemple 2](../../../../../../assets/noise_messy_fibers_3_v2_speed0.1_aniso0.gif "Fibres désordonnées 3 - Exemple 2"){zoomable="yes"}
...
![Fibres désordonnées 3 - Exemple 3](../../../../../../assets/noise_messy_fibers_3_v2_speed0.1_aniso1.gif "Fibres désordonnées 3 - Exemple 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fibres désordonnées 3 - Exemple 4](../../../../../../assets/noise_messy_fibers_3_v2_speed0.1_aniso0.6.gif "Fibres désordonnées 3 - Exemple 4"){zoomable="yes"}
