...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fractal-sum-2.resources/fractal_sum_2_1.png" class="modal-image" alt="Somme fractale 2 - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="fractal-sum-2.resources/noise_fractal_sum_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Somme fractale 2 - Exemple 2" />
        </td>
