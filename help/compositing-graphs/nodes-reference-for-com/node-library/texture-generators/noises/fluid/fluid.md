...
Il s&#39;agit d&#39;un nœud intéressant qui génère un modèle fluide en écoulement ou en chute. C&#39;est l&#39;un des bruits les plus complexes, avec quelques paramètres.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fluid.resources/fluid-ex.gif" class="modal-image" alt="Fluide - Exemple 1" />
        </td>
