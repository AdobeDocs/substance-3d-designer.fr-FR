...
![Bruit directionnel 3 - Icône](directional-noise-3.resources/directional_noise_3.png "Bruit directionnel 3 - Icône"){width="200px"}
...
![Bruit directionnel 3 - Exemple 1](directional-noise-3.resources/directional_noise_3_1.png "Bruit directionnel 3 - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Bruit directionnel 3 - Exemple 2](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso0.gif "Bruit directionnel 3 - Exemple 2"){zoomable="yes"}
...
![Bruit directionnel 3 - Exemple 3](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso1.gif "Bruit directionnel 3 - Exemple 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Bruit directionnel 3 - Exemple 4](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.3_aniso0.6.gif "Bruit directionnel 3 - Exemple 4"){zoomable="yes"}
