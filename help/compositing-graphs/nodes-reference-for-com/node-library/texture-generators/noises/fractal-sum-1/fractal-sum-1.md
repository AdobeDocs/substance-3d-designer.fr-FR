...
![Somme fractale 1 - Icône](fractal-sum-1.resources/fractal-sum-1-01.png "Somme fractale 1 - Icône"){width="200px"}
...
![Somme fractale 1 - Exemple 1](fractal-sum-1.resources/fractal-sum-1-02.png "Somme fractale 1 - Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Somme fractale 1 - Exemple 2](fractal-sum-1.resources/fractal-sum-1-03.gif "Somme fractale 1 - Exemple 2"){zoomable="yes"}
