...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-rust-fine.resources/grungerustfine-variant2.jpg" class="modal-image" alt="Usure/salissures Rouille Fine - Exemple 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-rust-fine.resources/grungerustfine-variant.jpg" class="modal-image" alt="Usure/salissures Rouille Fine - Exemple 2" />
        </td>
