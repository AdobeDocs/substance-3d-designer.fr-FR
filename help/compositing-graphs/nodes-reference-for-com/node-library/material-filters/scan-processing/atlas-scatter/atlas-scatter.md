...
breadcrumb-title: ''
description: Utilisez le nœud Atlas scatter pour effectuer la dispersion des textures dans un atlas afin de créer des motifs juxtaposés à partir de matériaux numérisés.
...
| <b>Réduire l’opacité de l’atlas (détection plus rapide)</b> <i>-4 - 0</i> | Permet de contrôler le rapport de réduction de l’échelle de la map opacity d’atlas d’entrée, qui est utilisée pour la détection de forme. Une résolution inférieure améliore les performances au détriment de la précision. |
...
| <b>Conserver le rapport de grandeur</b> <i>0.0 - 1.0</i> | Détermine le degré de conservation des proportions d’origine des formes dispersées, au lieu d’utiliser le rapport entre les cellules de grille, c’est-à-dire le rapport entre les valeurs Quantité X et Quantité Y. |
| <b>Position</b> |  |
...
| <b>Décalage Horizontal</b> <i>-2.0 - 2.0</i> | Multiplicateur pour le décalage de position le long de l’axe X. |
...
| <b>Multiplicateur de Map rotation</b> <i>0.0 - 1.0</i> | Multiplie la rotation de la forme en fonction de la valeur de niveaux de gris de l’image d&#39;entrée. |
...
| <b>Mode Fusion</b> <i>Fusion D&#39;Height, Test D&#39;Alpha</i> | Définit la méthode de résolution des chevauchements de formes. |
...
| <b>Multiplicateur de mappage aléatoire du masque</b> <i>0.0 - 1.0</i> | Définit le masquage de forme aléatoire en fonction de la saisie d’image en niveaux de gris. |
