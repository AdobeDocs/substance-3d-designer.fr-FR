...
breadcrumb-title: ''
description: Utilisez le nœud Encoche du bord pour générer des motifs d'entaille sur les bords du maillage afin de créer des effets réalistes d'endommagement et de retrait des bords.
