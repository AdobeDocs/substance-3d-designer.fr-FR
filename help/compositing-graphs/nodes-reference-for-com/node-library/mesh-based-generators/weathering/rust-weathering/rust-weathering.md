...
* **Effet**
  * **Répartition des Rouilles** : *0.0 - 1.0*
  * **Répartition du Smoothness** : *0.0 - 1.0*
  * **Échelle de dégâts de Vernish** : *0.0 - 1.0*
  * **Intensité des gouttes** : *0,0 - 1,0*
  * **Quantité D&#39;Échantillons Goutte** : *0 - 32*
  * **Smoothness gouttes** : *0.0 - 1.0*
* **Fusion**
