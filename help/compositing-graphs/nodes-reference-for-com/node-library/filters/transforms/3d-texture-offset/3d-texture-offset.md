...
* **Entrée** *Niveaux De Gris/Couleur*\
  *Texture 3D* décrivant un objet 3D.\
  L&#39;objet est généralement décrit dans un *cube unitaire*.

### Paramètres

* **Décalage** *Float3*\
  Quantité de décalage dans l&#39;*espace univers* appliquée à l&#39;objet décrit par la *texture 3D* connectée à l&#39;**entrée**.
