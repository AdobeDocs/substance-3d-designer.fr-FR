...
![Couleur médiane du filtre : icon](median-filter-color.resources/MedianFilter_Icon_Color.png "Couleur médiane du filtre : icon")
...
| <b>Affecter alpha</b> *Booléen* | Détermine si le filtre doit être appliqué au canal Alpha de l’image. Lorsque *True*, la couche alpha reste inchangée. |
