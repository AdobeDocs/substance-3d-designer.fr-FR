...
|  |  |
| --- | --- |
| <b>Sortie</b> *Couleur* | Résultat du mappage des couleurs de la palette modifiée aux index du mappage d’ID. |
| <b>Palette</b> *Couleur* | Palette mise à jour avec application des modifications de couleur spécifiées.   La palette peut être appliquée à une autre image avec le nœud [Appliquer la palette de couleurs](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/apply-color-palette/apply-color-palette.md) ou visualisée avec le nœud [Afficher la palette de couleurs](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/view-color-palette/view-color-palette.md). |

## Paramètres

|  |  |
| --- | --- |
| <b>Mode de sélection des couleurs</b> *Nombre entier* | Méthode de sélection de la couleur cible dans la palette qui doit être modifiée :<ul data-preserve-html="true"> <li data-preserve-html="true"><b>Index de couleur :</b> index de la couleur cible</li> <li data-preserve-html="true"><b>Espace image :</b> position dans le mappage d&#39;ID où l&#39;index doit être échantillonné. Lorsque ce mode est sélectionné, un widget de position est disponible dans la vue 2D pour faciliter la sélection</li> </ul> |
| <b>Position de la couleur</b> *Float2* *Disponible lorsque le mode de sélection des couleurs est défini sur « Espace image »* | Position dans le mappage d’ID où l’index doit être échantillonné.   Utilisez l’objet dans la vue 2D pour sélectionner facilement un emplacement dans l’image.   Conseil : vous pouvez afficher l’image quantifiée à partir de laquelle la carte d’identité est extraite, puis sélectionner le nœud Modifier la palette de couleurs pour afficher l’objet. La sélection d’une couleur à modifier devient ainsi plus intuitive. |
| <b>Index de couleurs</b> *Nombre entier* *Disponible lorsque le « mode de sélection des couleurs » est défini sur « Index des couleurs »* | Index de la couleur cible.   Les couleurs de la palette sont classées de gauche à droite et l’index de la première couleur est 0. |
...
| <b>Remplacer la couleur</b> *Float3* *Disponible lorsque &#39;Mode&#39; est défini sur &#39;Couleur de remplacement&#39;* | Indique la couleur qui doit remplacer la couleur d’origine. |
| <b>TSL</b> *Float3* *Disponible lorsque &#39;Mode&#39; est défini sur &#39;HSL&#39;* | Contrôle les décalages de teinte, de saturation et de luminosité appliqués à la couleur d’origine. |
