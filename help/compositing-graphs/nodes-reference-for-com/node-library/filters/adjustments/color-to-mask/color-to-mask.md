...
|  |  |
| --- | --- |
| Couleur <b>D&#39;Entrée</b> | Image couleur d’entrée à partir de laquelle un masque doit être extrait en fonction de ses couleurs. |
| <b>Entrée couleur</b> *Disponible lorsque l&#39;option Utiliser l&#39;entrée couleur est définie sur « Vrai »* | Image couleur d’entrée utilisée pour définir la couleur de référence par pixel. |

## Sorties

|  |  |
| --- | --- |
| <b>Sortie</b> *Niveaux de gris* | Masque généré sous forme d’image bitmap en niveaux de gris. |

## Paramètres

|  |  |
| --- | --- |
| <b>Utiliser une entrée de couleur</b> booléenne | Utilisez une image d’entrée au lieu d’une couleur uniforme, afin de définir une couleur de référence par pixel.    L&#39;image d&#39;entrée est fournie par l&#39;entrée <b>Entrée couleur</b>. |
| <b>Couleur</b> Float3 *Disponible lorsque &#39;Utiliser l&#39;entrée de couleur&#39; est défini sur &#39;Faux&#39;* | Couleur uniforme de référence autour de laquelle la sélection de couleurs doit être effectuée. |
| <b>Seuil</b> Flottant | Distance jusqu’à la couleur de référence en dessous de laquelle les couleurs sont sélectionnées. |
| <b>Fondu de sélection</b> flottant | Atténuez la sélection de couleurs en fonction de la distance par rapport à la couleur de référence. |
