...
breadcrumb-title: ''
description: Utilisez le nœud Appliquer la palette de couleurs pour remapper les textures à l’aide d’une palette de couleurs pour les effets de couleur stylisés.
...
Applique les couleurs d’une palette ordonnée à une image à l’aide d’un Map id.

La distribution des couleurs s’effectue en faisant correspondre les index du Map id aux index des couleurs de la palette.
...
|  |  |
|:---|:---|
| <b>Sortie</b> <i>Couleur</i> | Résultat du mappage des couleurs de la palette aux index du Map id. |
