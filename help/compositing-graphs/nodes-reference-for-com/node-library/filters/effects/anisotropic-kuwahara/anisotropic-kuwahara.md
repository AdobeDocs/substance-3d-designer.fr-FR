...
| <b>Ignorer alpha</b> <i>Booléen</i> | Lorsque la valeur est True, la couche alpha de l’image n’est pas affectée par le filtre.   Lorsque la valeur est False, le filtre est également appliqué à la couche alpha. |
