...
| <b>Activer le Dithering</b> <i>Vrai/Faux</i> | Contrôle la méthode d’échantillonnage de chaque passe. Le dithering permet la convergence en moins de passes, mais introduit le bruit.<br>Sans cette option, chaque passe est plus rapide, mais davantage de passes sont nécessaires pour obtenir un résultat fluide sans artefacts de bande. |
