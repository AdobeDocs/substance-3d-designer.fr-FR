...
Le nœud **Position de texture 3D** génère les *tranches de position* d&#39;un cube unitaire.

Cela peut être utilisé pour cuire des bruits 3D ou fonctionne comme un *atlas de textures 3D*.
