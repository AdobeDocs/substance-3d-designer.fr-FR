...
* **Couleur de surbrillance** : *(Valeur de couleur)*Couleur de la surbrillance specular.
* **Couleur des tons foncés** : *(Valeur de couleur)*Couleur utilisée dans les zones ombrées/non éclairées.
* **Gloss** : *0,0 - 0,5* taille de la surbrillance.
* **Intensité** : *0,0 - 10,0* Intensité de la mise en surbrillance.
