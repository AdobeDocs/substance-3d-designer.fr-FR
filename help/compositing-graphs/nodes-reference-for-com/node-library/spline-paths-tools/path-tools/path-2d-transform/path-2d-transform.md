...
breadcrumb-title: ''
description: Utilisez le nœud de Transforme Tracé 2D pour transformer des tracés avec des opérations de translation, de rotation et de mise à l’échelle.
...
# Transforme 2D de tracé

<table>
<tr style="border: 0;">
<td width="33.33%" style="border: 0;" valign="top">

![Icône de nœud](path-2d-transform.resources/path-2d-transform-icon.png "Icône de nœud")
...
Transforme des tracés à l’aide d’un widget.
