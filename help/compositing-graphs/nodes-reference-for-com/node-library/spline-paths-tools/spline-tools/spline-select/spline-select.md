...
![Icône de nœud](spline-select.resources/spline-select-01.png "Icône de nœud")
...
![Exemple de nœud 1](spline-select.resources/spline-select-06.gif "Exemple de nœud 1")
