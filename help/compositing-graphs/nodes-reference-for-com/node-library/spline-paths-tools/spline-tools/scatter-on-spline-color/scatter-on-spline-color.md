...
<b>Démarrer</b> *Flottant* Décale le point à partir du début d&#39;une spline où commence la diffusion. La valeur est la longueur normalisée de chaque spline.
...
* X : le Thickness est multiplié par rapport à la taille sur l’axe X uniquement ;
...
*- Add* : ajoutez les couleurs ensemble ;
* *Fusion d&#39;Alpha* : applique une fusion de transparence simple à l&#39;aide de la couche alpha du motif. Les motifs dessinés en dernier se trouvent au premier plan.

<b>Mode colorimétrique</b> *Nombre entier* Méthode de fusion consistant à sélectionner la couleur de chaque motif :\
*- Couleur de base* : la couleur de base est appliquée à tous les motifs ;
* *Position* : la position du motif dans l&#39;espace de la texture est utilisée pour piloter sa couleur afin que les coordonnées X et Y soient mappées sur les couches rouge et verte respectivement.

<b>Couleur de base de la forme</b> *Float4* Couleur de base des motifs.

<b>Multiplicateur d&#39;entrée de couleur</b> *Flottant* Contrôle l’intensité de l’entrée de la table des couleurs. Cette map agit comme un multiplicateur pour la couleur courante des motifs.\
...
<b>Mode D&#39;Échantillonnage D&#39;Entrée De La Carte Colorimétrique</b> *Entier* Méthode de mappage des valeurs de la table de couleurs sur les splines :\
*- Espace de texture* : les valeurs sont appliquées aux splines où elles se trouveraient si elles étaient placées dans une texture à l&#39;aide des coordonnées UV de la texture. Cela applique effectivement la valeur aux cannelures « en place »;\
*- Horizontal le long de la spline* : les valeurs sont appliquées directement aux coordonnées des splines codées (voir Entrée des cordons de spline), où chaque ligne est appliquée à une spline différente de haut en bas ;\
*- Heure. le long de la spline (rand. offset X)* : les valeurs sont appliquées directement aux coordonnées des splines codées (voir la saisie Spline Coords), avec un décalage horizontal aléatoire dans la table des couleurs pour chaque spline (c&#39;est-à-dire chaque ligne dans Spline Coords) ;\
*- Heure. le long de la spline (rand. décalage Y)* : les valeurs sont appliquées directement aux coordonnées des splines codées (voir la section Saisie des cordons de spline), avec un décalage vertical aléatoire dans la table des couleurs de chaque spline (c&#39;est-à-dire, chaque ligne dans les cordons de spline).

<b>Couleur aléatoire</b> *Float4* Applique un décalage aléatoire jusqu’aux valeurs spécifiées aux couleurs des motifs dans l’espace HSV, ainsi qu’à leur alpha.\
*Remarque :* la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleur.

<b>Centre de couleurs aléatoire</b> *Flottant* Applique un décalage à la plage du décalage aléatoire appliqué dans Couleur aléatoire\
Une valeur de -1 signifie que toutes les valeurs aléatoires sont supérieures et une valeur de 1 signifie que toutes les valeurs aléatoires sont inférieures.
...
<b>Multiplicateur de Thickness spline</b> *Variable* Intensité par laquelle l&#39;alpha de chaque motif est multiplié par rapport au thickness de la spline à son emplacement.\
Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleurs.

<b>Multiplicateur d&#39;échelle de forme</b> *Variable* Intensité par laquelle l’alpha de chaque motif est multiplié par rapport à son échelle.\
Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleurs.

<b>Multiplicateur d&#39;index de forme</b> *Variable* Intensité par laquelle l’alpha de chaque motif est multiplié par rapport à son index normalisé.\
Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleurs.

<b>Multiplicateur d&#39;Height spline</b> *Variable* Intensité par laquelle l&#39;alpha de chaque motif est multiplié par rapport à l&#39;height de la spline à son emplacement.\
Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleurs.

<b>Luminance aléatoire</b> *Flottant* Applique un multiplicateur aléatoire jusqu&#39;à la valeur spécifiée pour diminuer l&#39;alpha des motifs.\
Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleurs.
