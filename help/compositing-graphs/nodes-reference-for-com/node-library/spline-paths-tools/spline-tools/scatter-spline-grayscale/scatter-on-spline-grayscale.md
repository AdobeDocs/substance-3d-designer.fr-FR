...
| <b>Couleur de base de la forme</b> <i>Flotter</i> | Base color des motifs. |
| <b>Multiplicateur de couleur de base de la forme</b> <i>Flotter</i> | Intensité de la Base color de forme des motifs.<br>Remarque : la couleur de sortie est le résultat pondéré de tous les multiplicateurs de couleur. |
