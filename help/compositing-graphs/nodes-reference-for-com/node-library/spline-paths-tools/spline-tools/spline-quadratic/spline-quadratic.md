...
![Spline (quadratique) : icon](spline-quadratic.resources/spline-quadratic-01.png "Spline (quadratique) : icon")
...
| <b>height final</b> <i>Flotter</i> | Ajuste l&#39;height du point <b>p3</b> où une valeur inférieure signifie un emplacement plus bas ou plus profond.<br>Cela a un impact sur le thickness de la spline à <b>p3</b>. |
| <b>height de tangente automatique</b> <i>Booléen</i> | Ajuste l&#39;height du point <b>p3</b> où une valeur inférieure signifie un emplacement plus bas ou plus profond.<br>Cela a un impact sur le thickness de la spline à <b>p3</b>. |
| <b>height tangent</b> <i>Flotter</i> | Ajuste l&#39;height piloté par les tangentes contrôlées par le point <b>p2</b>.<br>Cela a un impact sur l&#39;height le long de la spline, car il s&#39;éloigne de <b>p1</b> et entre dans <b>p3</b>.<br><i>Remarque :</i> ce paramètre n&#39;est disponible que lorsque <b>height de tangente automatique</b> est défini sur « False ». |
| <b>Thickness</b> |  |
| <b>Démarrer le thickness</b> <i>Flotter</i> | Ajuste le thickness du point <b>p1</b>. Cela a un impact sur le thickness de la spline à <b>p1</b>.<br><i>Remarque :</i> le Thickness est utilisé par des nœuds de spline spécifiques. |
| <b>Fin de thickness</b> <i>Flotter</i> | Ajuste le thickness du point <b>p3</b>. Cela a un impact sur le thickness de la spline à <b>p3</b>.<br><i>Remarque :</i> le Thickness est utilisé par des nœuds de spline spécifiques. |
| <b>thickness tangent automatique</b> <i>Booléen</i> | Définit automatiquement le thickness des tangentes de spline pour une interpolation linéaire entre le <b>Thickness de début</b> et le <b>Thickness de fin</b>.<br><i>Remarque :</i> le Thickness est utilisé par des nœuds de spline spécifiques. |
| <b>thickness tangent</b> <i>Flotter</i> | Ajuste le thickness entraîné par les tangentes contrôlées par le point <b>p2</b>.<br>Cela a un impact sur le thickness le long de la spline, car il s&#39;éloigne de <b>p1</b> et entre dans <b>p3</b>.<br><i>Remarque :</i> le Thickness est utilisé par des nœuds de spline spécifiques.<br><i>Remarque 2 :</i> ce paramètre est uniquement disponible lorsque <b>thickness tangent automatique</b> est défini sur « False ». |
| <b>Coordonnées des points</b> |  |
| <b>p1</b> <i>Float2</i> | Définit la position du point <b>p1</b> dans l&#39;espace de texture. |
| <b>p2</b> <i>Float2</i> | Définit la position du point <b>p2</b> dans l&#39;espace de texture.<br>Le point <b>p2</b> contrôle les <i>tangentes</i> des points <b>p1</b> et <b>p3</b>. |
| <b>p3</b> <i>Float2</i> | Définit la position du point <b>p3</b> dans l&#39;espace de texture. |
| <b>Aperçu</b> |  |
| <b>Afficher les tangentes</b> <i>Booléen</i> | Affiche la tangente de « sortie » du point <b>p1</b> et la tangente d&#39;« entrée » du point <b>p3</b> dans la sortie <b>Aperçu</b>. Inverse la direction de la spline. |
...
| <b>Quantité de segments</b> <i>Nombre entier</i> | Ajuste le nombre de segments utilisés pour dessiner la visualisation de la spline dans la sortie <b>Aperçu</b>.<br>Plus la valeur est élevée, plus la ligne est lisse. |
| <b>Thickness (px)</b> <i>Flotter</i> | Ajuste le thickness en pixels de la visualisation de la spline dans la sortie <b>Aperçu</b>. |
...
![Spline (Quadratique) : Exemple 1](spline-quadratic.resources/spline-quadratic-02.png "Spline (Quadratique) : Exemple 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Spline (Quadratique) : Exemple 2](spline-quadratic.resources/spline-quadratic-03.png "Spline (Quadratique) : Exemple 2"){zoomable="yes"}
...
![Spline (Quadratique) : Demo](spline-quadratic.resources/spline-quadratic-04.gif "Spline (Quadratique) : Demo"){zoomable="yes"}
