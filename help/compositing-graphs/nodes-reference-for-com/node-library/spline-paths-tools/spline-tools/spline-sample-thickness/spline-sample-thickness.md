...
![Icône de nœud](../../../../../../assets/spline-sample-thickness-icon.png "Icône de nœud")
...
<b>Mappage de Thickness</b> *Niveaux de gris* Image en niveaux de gris utilisée pour modifier le thickness de la spline d&#39;entrée.
...
<b>Mode d&#39;échantillonnage</b> *Entier* Méthode de mappage des valeurs de la courbe de Thickness aux splines :\
...
<b>Opacité</b> *Variable* Multiplicateur de l&#39;intensité de la contribution de l&#39;entrée de courbe de Thickness au thickness de la spline.<b></b>

<b>Mode de fusion</b> *Entier* Méthode de fusion des données de la courbe de transfert de Thickness avec le <span id="_Hlk135820484"></span>thickness de la spline d&#39;entrée :\
*- Copier* : remplacer le thickness de la spline par les valeurs de courbe de transfert d&#39;Height ;\
*- Add* : ajoutez les valeurs de courbe de Thickness au thickness de la spline ;\
*- Soustraire* : soustrayez les valeurs de courbe de Thickness au thickness de la spline ;\
*- Multiplier* : multipliez les valeurs de courbe de Thickness par rapport au thickness de la spline.
...
![Exemple de nœud 1](../../../../../../assets/SplineSampleThickness-Variant1-After1.jpg "Exemple de nœud 1")

</td>
<td style="border: 0;" valign="top">

![Exemple de nœud 2](../../../../../../assets/SplineSampleThickness-Demo.gif "Exemple de nœud 2")
