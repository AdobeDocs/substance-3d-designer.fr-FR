...
![Icône de nœud](spline-flow-mapper.resources/spline-flow-mapper-01.png "Icône de nœud")
...
![Exemple de nœud 2](spline-flow-mapper.resources/spline-flow-mapper-04.gif "Exemple de nœud 2")
