...
|  |  |
| --- | --- |
| <b>Mode Height de démarrage</b> *Nombre entier* | Méthode de calcul de l&#39;height de départ des splines diffusées.   Manuel Définissez la même valeur absolue pour toutes les splines diffusées.   À partir de la spline parente (+ spline personnalisée) Utilisez l&#39;height de la spline parente, puis ajoutez l&#39;height de la spline personnalisée à l&#39;aide du multiple d&#39;heights de début de spline <b>personnalisé.Paramètre </b>.   À partir d&#39;une spline personnalisée Utilisez l&#39;height de la spline personnalisée telle quelle.   *Remarque :* définissez <b>Type de spline</b> sur « Spline personnalisée » et connectez les entrées de <b>Spline personnalisée</b> pour utiliser l&#39;height de splines personnalisées. |
...
| <b>Mode d&#39;Height final</b> *Nombre entier* | Méthode de calcul de l&#39;height final des splines dispersées.   Manuel Définissez la même valeur absolue pour toutes les splines diffusées.   À partir de la spline parente (+ spline personnalisée) Utilisez l&#39;height de la spline parente, puis ajoutez l&#39;height de la spline personnalisée à l&#39;aide de la valeur Mult <b>Height d&#39;extrémité de spline personnalisé.Paramètre </b>.   À partir d&#39;une spline personnalisée Utilisez l&#39;height de la spline personnalisée telle quelle.     *Remarque :* définissez <b>Type de spline</b> sur Spline personnalisée et connectez les entrées de <b>Spline personnalisée</b> pour utiliser l&#39;height de splines personnalisées. |
