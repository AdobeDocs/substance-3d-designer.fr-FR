...
|  |  |
|:---|:---|
| <b>Quantité de spline du pont</b> <i>Entier</i> | Nombre de splines générées sur les splines d&#39;entrée. |
| <b>Type de splines Bridge</b> <i>Entier</i> | Type de spline générée :<br><br>- Linéaire : spline nette reliant les splines intermédiaires avec des trajectoires droites du début à la fin ;<br>- Bézier quadratique : spline courbe reliant les splines intermédiaires avec des trajectoires lisses du début à la fin.<br><br>Remarque : au moins 3 splines d&#39;entrée sont requises pour calculer une spline de Bézier quadratique. |
...
| <b>Décalage de la spline du premier pont</b> <i>Flottant 2</i> | Applique un décalage au début de toutes les splines traversées. La valeur est la longueur normalisée des splines d&#39;entrée.<br>Les splines générées qui correspondent au début ou à la fin des splines traversées y sont laissées. |
| <b>Décalage spline du dernier pont</b> <i>Flottant 2</i> | Applique un décalage à l&#39;extrémité de toutes les splines traversées. La valeur est la longueur normalisée des splines d&#39;entrée.<br>Les splines générées qui correspondent au début ou à la fin des splines traversées y sont laissées. |
| <b>Plage de décalage aléatoire</b> <i>Entier</i> | Distance maximale utilisée pour le décalage aléatoire appliqué sur les splines.<br><br>- <i>spline parent :</i> Toute la longueur des splines parentes est utilisée. Peut entraîner des chevauchements.<br>- <i>Intervalle :</i> L&#39;intervalle entre les splines du pont est utilisé. Cela atténue les chevauchements. Cette distance diminue lorsque la quantité de splines du pont augmente. |
| <b>Décalage aléatoire de début</b> <i>Flottant</i> | Multiplicateur du décalage aléatoire appliqué à la position de départ des splines de pont, où la distance maximale est spécifiée par le paramètre <b>Plage de décalage aléatoire</b>. |
| <b>Décalage aléatoire de fin</b> <i>Flottant</i> | Multiplicateur du décalage aléatoire appliqué à la position d&#39;extrémité des splines de pont, où la distance maximale est spécifiée par le paramètre <b>Plage de décalage aléatoire</b>. |
| <b>Décalage aléatoire global</b> <i>Flottant</i> | Multiplicateur pour le *montant égal* de décalage aléatoire appliqué sur *les deux* positions de début et de fin des splines de pont, où la distance maximale est spécifiée par le paramètre <b>Plage de décalage aléatoire</b>. |
...
| <b>Thickness</b> |  |
| <b>Mode Thickness</b> <i>Entier</i> | Méthode d&#39;acquisition de la valeur de thickness pour les splines de pont.<br><br>- <i>Hériter des splines parentes :</i> Le thickness des splines parentes aux positions de début et de fin des splines de pont est utilisé<br>- <i>Remplacement :</i> La valeur arbitraire que vous spécifiez dans le paramètre <b>Thickness</b> est utilisée |
| <b>Thickness</b> <i>Flottant</i> | Valeur de thickness absolue appliquée aux splines du pont. |
| <b>Thickness aléatoire</b> <i>Flottant</i> | Un multiplicateur aléatoire pour le thickness des splines de pont, où le thickness initial auquel ce multiplicateur est appliqué est spécifié par le paramètre <b>mode de Thickness</b>. |
| <b>Height</b> |  |
| <b>Mode Height</b> <i>Entier</i> | Méthode d&#39;acquisition de la valeur d&#39;height pour les splines de pont.<br><br>- <i>Hériter des splines parentes :</i> L&#39;height des splines parentes aux positions de début et de fin des splines de pont est utilisé<br>- <i>Remplacement :</i> La valeur arbitraire que vous spécifiez dans le paramètre <b>Height</b> est utilisée |
| <b>Décalage Height</b> <i>Flottant</i> | Spécifie le décalage appliqué à l&#39;height hérité des splines parentes, avant l&#39;application de cet height aux splines du pont. |
| <b>Height</b> <i>Flottant</i> | Valeur d&#39;height absolue appliquée aux splines du pont. |
| <b>Height aléatoire</b> <i>Flottant</i> | Une quantité aléatoire d&#39;ajustement de l&#39;height des splines du pont, où cet ajustement dépend du paramètre <b>mode d&#39;Height</b> sélectionné :<br><br>- <i>Hériter des splines parentes :</i> La valeur est un multiplicateur pour l&#39;height hérité.<br>- <i>Remplacement :</i> La valeur est un décalage ajouté à l&#39;height. |
...
| <b>Intensité de l&#39;aperçu de l&#39;arrière-plan</b> <i>Flottant</i> | Intensité de la visualisation de l’aperçu. |
...
![Nœud dans le graphe](spline-bridge-list.resources/SplineBridge-List_Graph.jpg "Nœud dans le graphe")
