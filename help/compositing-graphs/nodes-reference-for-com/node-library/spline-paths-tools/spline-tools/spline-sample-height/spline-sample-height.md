...
![Icône de nœud](spline-sample-height.resources/spline-sample-height-icon.png "Icône de nœud")
...
Modifie l&#39;height des splines d&#39;entrée en mappant une Map height d&#39;entrée sur elles.

L’effet de la map height mappée peut être ajusté en modifiant son mode de fusion et l’opacité de cet effet.
...
| <b>Map height</b> <i>Niveaux de gris</i> | Image en niveaux de gris d&#39;entrée utilisée pour modifier l&#39;height de la spline d&#39;entrée. |
...
![Exemple de nœud 1](spline-sample-height.resources/SplineSampleHeight-Variant1-After4.jpg "Exemple de nœud 1")

</td>
<td style="border: 0;" valign="top">

![Exemple de nœud 2](spline-sample-height.resources/SplineSampleHeight-Demo.gif "Exemple de nœud 2")
