...
![Menu déroulant Charger/Enregistrer la préconfiguration](parameter-presets.resources/parameter-presets-01.gif "Menu déroulant Charger/Enregistrer la préconfiguration"){width="512px"}
...
![Modification des paramètres prédéfinis intégrés](parameter-presets.resources/parameter-presets-02.gif "Modification des paramètres prédéfinis intégrés"){width="512px"}
