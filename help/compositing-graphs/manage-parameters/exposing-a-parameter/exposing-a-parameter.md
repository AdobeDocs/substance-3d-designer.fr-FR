...
![Paramètres d&#39;exposition simplifiés](exposing-a-parameter.resources/parameters-5.png "Paramètres d&#39;exposition simplifiés")
...
![Procédure pas à pas de méthode d&#39;exposition unique](exposing-a-parameter.resources/single-expose2.gif "Procédure pas à pas de méthode d&#39;exposition unique"){width="512px"}
...
1. Sélectionnez ![](exposing-a-parameter.resources/image2020-9-17-15-37-7.png) <b>Exposer comme nouvelle entrée de graphique</b> dans la liste déroulante, la première option.
...
![Procédure pas à pas de la méthode d&#39;exposition par lots](exposing-a-parameter.resources/batch-expose-2.gif "Procédure pas à pas de la méthode d&#39;exposition par lots"){width="512px"}
...
1. Au lieu de rechercher un seul paramètre, recherchez le bouton ![](exposing-a-parameter.resources/image2020-9-17-15-39-7.png) <b>Exposition multiple</b> en haut à droite de l&#39;onglet <b>Paramètres spécifiques</b>
...
1. Cliquez sur <b>OK</b> pour confirmer et afficher tous les paramètres sélectionnés. Les noms des paramètres affichent désormais *bleu* pour confirmer l&#39;affichage des paramètres, ainsi qu&#39;un bouton ![](exposing-a-parameter.resources/image2020-9-17-15-35-46.png) <b>Modifier la fonction</b>.
...
1. Cliquez sur le bouton Options de liste déroulante ![](exposing-a-parameter.resources/image2020-9-17-15-35-59.png) en regard du paramètre déjà exposé
1. Sélectionnez ![](exposing-a-parameter.resources/image2020-9-17-15-37-7.png)<b> Modifier l&#39;entrée de graphique exposée</b>. Cela vous amène directement à l’entrée correspondante dans les propriétés du graphique
...
Vous pouvez suivre quel paramètre est utilisé par quel nœud via l&#39;outil Node Finder Tool ![](exposing-a-parameter.resources/image2019-9-19-14-15-53.png), qui se trouve dans la barre supérieure de la vue Graphique. Cliquez dessus pour rechercher des nœuds à l&#39;aide de paramètres spécifiques.
