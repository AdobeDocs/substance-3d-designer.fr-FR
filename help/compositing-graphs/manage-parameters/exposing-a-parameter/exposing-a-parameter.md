...
Lors de l’exposition d’un paramètre, cette méthode est un peu plus lente que la précédente. Lorsque vous exposez plusieurs paramètres, c&#39;est beaucoup plus rapide.
