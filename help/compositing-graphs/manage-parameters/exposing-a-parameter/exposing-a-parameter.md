...
![Paramètres d&#39;exposition simplifiés](exposing-a-parameter.resources/exposing-a-parameter-01.png "Paramètres d&#39;exposition simplifiés")
...
![Procédure pas à pas de méthode d&#39;exposition unique](exposing-a-parameter.resources/exposing-a-parameter-02.gif "Procédure pas à pas de méthode d&#39;exposition unique"){width="512px"}
...
1. Cliquez sur le bouton des options déroulantes ![](exposing-a-parameter.resources/exposing-a-parameter-03.png)
1. Sélectionnez ![](exposing-a-parameter.resources/exposing-a-parameter-04.png) <b>Exposer comme nouvelle entrée de graphique</b> dans la liste déroulante, la première option.
...
1. Le nom du paramètre devient *bleu* et le ![](exposing-a-parameter.resources/exposing-a-parameter-05.png)\
...
![Procédure pas à pas de la méthode d&#39;exposition par lots](exposing-a-parameter.resources/exposing-a-parameter-06.gif "Procédure pas à pas de la méthode d&#39;exposition par lots"){width="512px"}
...
1. Au lieu de rechercher un seul paramètre, recherchez le bouton ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) <b>Exposition multiple</b> en haut à droite de l&#39;onglet <b>Paramètres spécifiques</b>
...
1. Cliquez sur <b>OK</b> pour confirmer et afficher tous les paramètres sélectionnés. Les noms des paramètres affichent désormais *bleu* pour confirmer l&#39;affichage des paramètres, ainsi qu&#39;un bouton ![](exposing-a-parameter.resources/exposing-a-parameter-05.png) <b>Modifier la fonction</b>.
...
1. Cliquez sur le bouton Options de liste déroulante ![](exposing-a-parameter.resources/exposing-a-parameter-03.png) en regard du paramètre déjà exposé
1. Sélectionnez ![](exposing-a-parameter.resources/exposing-a-parameter-04.png)<b> Modifier l&#39;entrée de graphique exposée</b>. Cela vous amène directement à l’entrée correspondante dans les propriétés du graphique
...
![Paramètres d&#39;entrée](exposing-a-parameter.resources/exposing-a-parameter-08.png "Paramètres d&#39;entrée"){width="512px"}
...
![Éditeur de liste déroulante pour le paramètre Entier](exposing-a-parameter.resources/exposing-a-parameter-09.gif "Éditeur de liste déroulante pour le paramètre Entier"){width="512px"}
...
![Réorganiser les paramètres d&#39;entrée](exposing-a-parameter.resources/exposing-a-parameter-10.gif "Réorganiser les paramètres d&#39;entrée"){width="512px"}
...
![Aperçu des paramètres d&#39;entrée](exposing-a-parameter.resources/exposing-a-parameter-11.gif "Aperçu des paramètres d&#39;entrée"){width="512px"}
...
![Copier et coller les paramètres d&#39;entrée](exposing-a-parameter.resources/exposing-a-parameter-12.gif "Copier et coller les paramètres d&#39;entrée"){width="512px"}

### COPIER-COLLER DES PARAMÈTRES

Les paramètres peuvent être copiés-collés entre les graphiques.

Un seul paramètre peut être copié avec le bouton Copier ![](exposing-a-parameter.resources/exposing-a-parameter-13.png). Plusieurs paramètres peuvent être copiés via le menu Paramètres ![](exposing-a-parameter.resources/exposing-a-parameter-07.png). Sélectionnez Copier les entrées pour copier toutes les entrées.

Sélectionnez Coller les entrées ![](exposing-a-parameter.resources/exposing-a-parameter-14.png) dans le menu Paramètres ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) pour coller un ou plusieurs paramètres.
...
![Erreurs sur les paramètres de nœud](exposing-a-parameter.resources/exposing-a-parameter-15.gif "Erreurs sur les paramètres de nœud"){width="512px"}

### SUIVI DES PARAMÈTRES ROMPUS SUR LES NOEUDS

Vous pouvez suivre quel paramètre est utilisé par quel nœud via l&#39;outil Node Finder Tool ![](exposing-a-parameter.resources/exposing-a-parameter-16.png), qui se trouve dans la barre supérieure de la vue Graphique. Cliquez dessus pour rechercher des nœuds à l&#39;aide de paramètres spécifiques.

Si un nœud a un problème réel, il affichera un badge d&#39;avertissement ![](exposing-a-parameter.resources/exposing-a-parameter-17.png) dans son coin supérieur gauche. Placer le pointeur de la souris sur le badge affiche une info-bulle contenant plus d’informations.

Pour réinitialiser et supprimer un problème, pour le paramètre que vous souhaitez corriger ou réinitialiser, cliquez sur le bouton déroulant ![](exposing-a-parameter.resources/exposing-a-parameter-03.png) en regard du bouton Modifier la fonction et sélectionnez ![](exposing-a-parameter.resources/exposing-a-parameter-18.png) <b>Réinitialiser. </b>Cela ramène un paramètre à son état précédent, non exposé. Le nom bleu redevient gris pour refléter cela.

![Nettoyage des paramètres d&#39;entrée inutilisés](exposing-a-parameter.resources/exposing-a-parameter-19.gif "Nettoyage des paramètres d&#39;entrée inutilisés"){width="512px"}

### NETTOYAGE DES PARAMÈTRES D&#39;ENTRÉE INUTILISÉS

Si vous avez perdu la trace de vos paramètres d’entrée et ne savez plus lesquels sont utilisés, ils peuvent être nettoyés à l’aide d’un petit outil. Cliquez sur le bouton du menu Paramètre d&#39;entrée ![](exposing-a-parameter.resources/exposing-a-parameter-07.png) et sélectionnez <b>Nettoyer les entrées</b>.
