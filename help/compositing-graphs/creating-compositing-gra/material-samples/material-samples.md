...
![Exemples de Matériau - Modèles de carte](material-samples.resources/material-samples-01.png "Exemples de Matériau - Modèles de carte")
...
![Boîte de dialogue Nouveau graphe de Substance - Exemples de Matériau](material-samples.resources/material-samples-02.png "Boîte de dialogue Nouveau graphe de Substance - Exemples de Matériau"){zoomable="yes"}
...
![Échantillons de Matériau - Bouton de bannière](material-samples.resources/material-samples-03.png "Échantillons de Matériau - Bouton de bannière"){zoomable="yes"}
...
![Échantillons de Matériau - Info-bulle de la carte de modèle](material-samples.resources/material-samples-04.png "Échantillons de Matériau - Info-bulle de la carte de modèle"){zoomable="yes"}
...
![Exemple de Matériau - Graphe](material-samples.resources/material-samples-05.png "Exemple de Matériau - Graphe"){zoomable="yes"}
