...
* 
  ...
  ![Boîte de dialogue Nouveau graphique de Substance - Créer à partir de l’écran d’accueil](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-01.png "Boîte de dialogue Nouveau graphique de Substance - Créer à partir de l’écran d’accueil"){zoomable="yes"}
...
* 
  ...
  Sur n&#39;importe quel élément de package *existant* dans l&#39;[Explorateur](../../interface/the-explorer-window/the-explorer-window.md), cliquez sur <b>RMB</b> et accédez à <b>Nouveau > graphique de Substance</b> dans le menu contextuel.

  </td>
  <td style="border: 0;" valign="top">

  ![Boîte de dialogue Nouveau graphique de Substance - Créer à partir de l&#39;Explorateur](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-02.png "Boîte de dialogue Nouveau graphique de Substance - Créer à partir de l&#39;Explorateur"){zoomable="yes"}
...
* 
  ...
  Dans la barre d&#39;outils principale, cliquez sur le bouton ![](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-03.png) <b>Nouveau graphique de Substance</b>.

  </td>
  <td style="border: 0;" valign="top">

  ![Boîte de dialogue Nouveau graphique de Substance - Créer à partir de la barre d&#39;outils principale](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-04.png "Boîte de dialogue Nouveau graphique de Substance - Créer à partir de la barre d&#39;outils principale"){zoomable="yes"}
...
* 
  ...
  Dans le menu principal, accédez à <b>Fichier > Nouveau > Graphique de Substance...</b>
...
![Boîte de dialogue Nouveau graphique de Substance - Matières](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-06.png "Boîte de dialogue Nouveau graphique de Substance - Matières"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique en Substance - Vignette](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-07.png "Boîte de dialogue Nouveau graphique en Substance - Vignette")
...
![Échantillons de matériaux - Bannière d’écran d’accueil](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-08.png "Échantillons de matériaux - Bannière d’écran d’accueil"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Info-bulle du modèle](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-09.png "Boîte de dialogue Nouveau graphique de Substance - Info-bulle du modèle"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Modes d’affichage](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-10.png "Boîte de dialogue Nouveau graphique de Substance - Modes d’affichage"){zoomable="yes"}
...
+++Modes d’affichage
![Boîte de dialogue Nouveau graphique de Substance - Vue Vignettes](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-11.png "Boîte de dialogue Nouveau graphique de Substance - Vue Vignettes"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique en Substance - Mode Liste](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-12.png "Boîte de dialogue Nouveau graphique en Substance - Mode Liste"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Vue Packs](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-13.png "Boîte de dialogue Nouveau graphique de Substance - Vue Packs"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Vue Répertoires](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-14.png "Boîte de dialogue Nouveau graphique de Substance - Vue Répertoires"){zoomable="yes"}
...
<b>Créer un graphique dans</b> : vous pouvez utiliser cette zone de liste déroulante pour créer un *nouveau* package pour le nouveau graphique ou ajouter le nouveau graphique à tout *package existant* déjà chargé dans le panneau [Explorateur](../../interface/the-explorer-window/the-explorer-window.md).
...
![Boîte de dialogue Nouveau graphique de Substance - Info-bulle d’aide](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-15.png "Boîte de dialogue Nouveau graphique de Substance - Info-bulle d’aide"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Filtrage par catégorie](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-16.png "Boîte de dialogue Nouveau graphique de Substance - Filtrage par catégorie"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Configuration de la catégorie de modèle](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-17.png "Boîte de dialogue Nouveau graphique de Substance - Configuration de la catégorie de modèle"){zoomable="yes"}
...
![Boîte de dialogue Nouveau graphique de Substance - Filtrage par fichier de projet](creating-a-substance-compositing-graph.resources/creating-a-substance-compositing-graph-18.png "Boîte de dialogue Nouveau graphique de Substance - Filtrage par fichier de projet"){zoomable="yes"}
