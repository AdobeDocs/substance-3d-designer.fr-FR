...
![Nœud de la valeur de sortie](values-in-substance-compositing-graphs.resources/values-output.gif "Nœud de la valeur de sortie"){width="512px"}
...
![Ajout de valeurs d&#39;entrée sur le nœud](values-in-substance-compositing-graphs.resources/values-inputs.gif "Ajout de valeurs d&#39;entrée sur le nœud")
...
![Utilisation des valeurs](values-in-substance-compositing-graphs.resources/yellowhighlight.png "Utilisation des valeurs")
