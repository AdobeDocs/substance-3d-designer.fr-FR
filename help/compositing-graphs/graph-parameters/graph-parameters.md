...
![Paramètres de base](graph-parameters.resources/graph-parameters-01.png "Paramètres de base"){width="512px" zoomable="yes"}
...
| <b>Générateur aléatoire</b> | Définit la *valeur de départ aléatoire* de base du graphique.  Utilisez la commande <div><img data-preserve-html="true" height="22" src="graph-parameters.resources/graph-parameters-03.jpg"/></div> pour attribuer une nouvelle valeur aléatoire à la valeur de départ aléatoire.<br><br>*Par défaut : 0 - Relative au parent* |
...
![Attributs de graphique](graph-parameters.resources/graph-parameters-04.png "Attributs de graphique"){zoomable="yes"}
...
|                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|:---------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Identifiant** | Il s&#39;agit du nom du graphe, qui doit être *unique*. Vous ne pouvez pas avoir deux graphes ou plus avec le même <b>Identifiant</b> dans le même pack. Il est utilisé comme *nom* du graphique dans le panneau [Explorateur](../../interface/the-explorer-window/the-explorer-window.md).<br><br>*Remarque :* l&#39;identificateur *ne peut pas être une chaîne vide*. Les chaînes vides sont automatiquement remplacées par `_` ou `Substance_graph`. Vous ne pouvez utiliser *que* les caractères suivants pour cette valeur : *`A-Z, 1-9, @$%[{]}_-`.* Les caractères non autorisés sont automatiquement remplacés par `_`.<br><br>*Par défaut : nouveau\_graphe, ou définis par l’utilisateur lors de la création du graphe* |
...
| **Description** | Il s&#39;agit du *texte de description* du graphique.Il est visible dans l&#39;*info-bulle* pour l&#39;entrée de graphe dans la **bibliothèque**, n&#39;importe quel nœud de **instance** pour ce graphe et le logiciel avec une **intégration de Substance de données** existante.*Par défaut : vide* |
...
![Paramètres d&#39;entrée](graph-parameters.resources/graph-parameters-05.png "Paramètres d&#39;entrée"){zoomable="yes"}
...
![Entrées](graph-parameters.resources/graph-parameters-06.png "Entrées"){zoomable="yes"}
...
![Sorties](graph-parameters.resources/graph-parameters-07.png "Sorties"){zoomable="yes"}
