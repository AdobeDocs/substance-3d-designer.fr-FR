...
Le bouton <b>Actualiser</b> peut être utilisé pour *mettre à jour* la liste des plug-ins. Ceci est utile lorsque les plug-ins sont chargés à l’aide de l’API Python.

>[!NOTE]
>
> Si le plug-in est un *module* (c’est-à-dire un répertoire), il peut être chargé en choisissant le fichier <b>\_\_init\_\_.py</b> dans le module.
