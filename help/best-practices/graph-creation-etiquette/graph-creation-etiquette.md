...
![Images dans les graphiques en Substances](graph-creation-etiquette.resources/graph-creation-etiquette-01.gif "Images dans les graphiques en Substances")
...
![Position des entrées et sorties](graph-creation-etiquette.resources/graph-creation-etiquette-02.gif "Position des entrées et sorties")
...
![Réacheminement des liens](graph-creation-etiquette.resources/graph-creation-etiquette-03.gif "Réacheminement des liens")
...
![Identifiant et libellé](graph-creation-etiquette.resources/graph-creation-etiquette-04.png "Identifiant et libellé")
...
![Clarté de l’identifiant](graph-creation-etiquette.resources/graph-creation-etiquette-05.png "Clarté de l’identifiant")
...
![Étiquettes de cadre et de paramètre correspondantes](graph-creation-etiquette.resources/graph-creation-etiquette-06.png "Étiquettes de cadre et de paramètre correspondantes")
...
![Conversions de couleurs et de niveaux de gris](graph-creation-etiquette.resources/graph-creation-etiquette-07.png "Conversions de couleurs et de niveaux de gris")
...
* Les nœuds ne doivent généralement pas avoir de paramètres de remplacement pour la taille de sortie. Dans la plupart des cas, il est préférable de contrôler la résolution via les propriétés Parent ou Graphique.
* Pour les bitmaps, veillez tout particulièrement à ce que la taille de sortie absolue par défaut ne s’étende pas à l’ensemble du graphique. Dans ce cas, elle doit être remplacée par Relative au parent. Il s&#39;agit de l&#39;une des rares exceptions à la règle ci-dessus.
