---
title: Pyramide
description: Designer > graphes de composition de Substance > Référence des nœuds pour les graphes de composition de Substance > Bibliothèque de nœuds > Fonction SDF > Primitive > Pyramide
...
Icône ![Pyramide](./3d-sdf-pyramid.png "Pyramide")
...
| <b>Taille de base</b> *Flottant 2* | Taille de la base de la pyramide en X et Y.<br><br><i>Valeur par défaut : (1, 1)</i> |
