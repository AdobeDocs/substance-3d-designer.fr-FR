---
title: Pyramide
description: Designer > Graphes de composition de Substances > Référence des nœuds pour les graphes de composition de Substances > Bibliothèque de nœuds > Fonction SDF > Primitive > Pyramide
...
![Icône de pyramide](./3d-sdf-pyramid.png "Pyramide")
...
L&#39;invention concerne une Fonction SDF pour une pyramide d&#39;height, de taille et de position de base réglables.
...
| <b>Taille de base</b> *Float2* | Taille de la base de la pyramide en X et Y.<br><br><i>Valeur par défaut : (1, 1)</i> |
