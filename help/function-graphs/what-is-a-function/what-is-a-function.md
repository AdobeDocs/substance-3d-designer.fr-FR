...
Mais plutôt que d’utiliser des lignes de codes, les fonctions de Designer conservent la même approche nodale. À première vue, un graphique fonctionnel ressemble beaucoup à un graphique ordinaire.
...
Par conséquent, vous pouvez imaginer des règles et des dépendances entre les parties de votre graphique, pour obtenir des résultats uniques.
...
si vous avez exposé un paramètre, vous avez automatiquement créé une fonction et une variable : la fonction contient un nœud get float qui intercepte la valeur de la variable nouvellement créée :
