...
Le graphe de fonction fonctionne de la même manière que les autres types de graphes dans Designer : avec un éditeur de nœuds.
...
Contrairement au graphe de Substance, la fonction n&#39;a pas de nœud « Output », vous devez spécifier quel nœud dans le graphe est la sortie de la fonction.
...
>[!WARNING]
>
> Une fonction doit avoir une sortie pour fonctionner. Vous verrez un avertissement dans votre graphe si votre fonction n’a pas de jeu de sortie.
