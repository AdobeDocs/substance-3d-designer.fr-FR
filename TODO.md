...
* Modèles pour pages de répertoire + script pour mettre à jour les pages en fonction de la hiérarchie actuelle
* Mettre à jour les pages de nœuds existantes vers un modèle fourni
